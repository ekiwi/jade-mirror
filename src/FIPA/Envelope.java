/*
 * File: ./FIPA/ENVELOPE.JAVA From: FIPA.IDL Date: Mon Sep 04 15:08:50 2000 By: idltojava Java IDL
 * 1.2 Nov 10 1997 13:52:11
 */
...
public final class Envelope {
  ...
  public Envelope(FIPA.AgentID[] __to, FIPA.AgentID[] __from, String __comments,
      String __aclRepresentation, int __payloadLength, String __payloadEncoding,
      FIPA.DateTime[] __date, String[] __encrypted, FIPA.AgentID[] __intendedReceiver,
      FIPA.ReceivedObject[] __received, FIPA.Property[][] __transportBehaviour,
      FIPA.Property[] __userDefinedProperties) {
    to = __to;
    from = __from;
    comments = __comments;
