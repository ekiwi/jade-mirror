/*
 * File: ./FIPA/OPTRECEIVEDOBJECTHELPER.JAVA From: FIPA.IDL Date: Mon Sep 04 15:08:50 2000 By:
 * idltojava Java IDL 1.2 Nov 10 1997 13:52:11
 */
...
public class OptReceivedObjectHelper {
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (_tc == null)
      _tc = org.omg.CORBA.ORB.init().create_alias_tc(id(), "OptReceivedObject", org.omg.CORBA.ORB
          .init().create_sequence_tc((int) (1L), FIPA.ReceivedObjectHelper.type()));
    return _tc;
  }
