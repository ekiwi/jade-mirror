/*
 * File: ./FIPA/OPTTRANSPORTBEHAVIOURTYPEHELPER.JAVA From: FIPA.IDL Date: Mon Sep 04 15:08:50 2000
...
public class OptTransportBehaviourTypeHelper {
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (_tc == null)
      _tc = org.omg.CORBA.ORB.init().create_alias_tc(id(), "OptTransportBehaviourType",
