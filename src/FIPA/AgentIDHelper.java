/*
 * File: ./FIPA/AGENTIDHELPER.JAVA From: FIPA.IDL Date: Mon Sep 04 15:08:50 2000 By:
 * c:\Java\idltojava-win32\idltojava Java IDL 1.2 Nov 10 1997 13:52:11
 */
...
public class AgentIDHelper {
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    ...
    if (_tc == null) {
      ...
      _members[1] =
          new org.omg.CORBA.StructMember("addresses", org.omg.CORBA.ORB.init().create_sequence_tc(0,
              org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string)), null);
      ...
      _members[2] = new org.omg.CORBA.StructMember("resolvers",
          ...
          org.omg.CORBA.ORB.init().create_sequence_tc(0,
              org.omg.CORBA.ORB.init().create_recursive_tc(id())),
          null);
