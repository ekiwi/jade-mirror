/*
 * File: ./FIPA/TRANSPORTBEHAVIOURTYPEHELPER.JAVA From: FIPA.IDL Date: Mon Sep 04 15:08:50 2000 By:
...
public class TransportBehaviourTypeHelper {
  ...
  synchronized public static org.omg.CORBA.TypeCode type() {
    if (_tc == null)
      _tc = org.omg.CORBA.ORB.init().create_alias_tc(id(), "TransportBehaviourType",
