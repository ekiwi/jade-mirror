...
/**
 * This example shows the usage of the <code>FSMBehavior</code> that allows composing behaviours
 * according to a Finite State Machine.<br>
 * 
...
public class FSMAgent extends Agent {
  ...
  /**
   * Inner class RandomGenerator. This behaviour prints its name and exits with a random value
