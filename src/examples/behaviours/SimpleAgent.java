 ...
 * More in details this agent executes a <code>CyclicBehaviour</code> that shows a printout at each
 * round and a generic behaviour that performs four successive "dummy" operations. The second
 * operation in particular involves adding a <code>OneShotBehaviour</code>. When the generic
 * behaviour completes the agent terminates.
 * 
