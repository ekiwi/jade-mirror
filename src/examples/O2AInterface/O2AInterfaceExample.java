...
/**
 * This class shows an example of how to run JADE as a library from an external program and in
 * particular how to start an agent and interact with it by means of the Object-to-Agent (O2A)
 * interface.
 * 
...
public class O2AInterfaceExample {
  ...
  public static void main(String[] args) throws StaleProxyException, InterruptedException {
    ...
    AgentController agentCtrl =
        mainCtrl.createNewAgent("CounterAgent", CounterAgent.class.getName(), new Object[0]);
    agentCtrl.start();
    ...
    try {
      // Retrieve O2A interface CounterManager1 exposed by the agent to make it
