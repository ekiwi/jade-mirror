...
/**
 * This agent shows how to use an OntologyServer behaviour to serve incoming messages (REQUESTs in
 * this case) refering to a given ontology. In this minimal example the agent keeps an internal time
 * and serves requests to - retrieve the value of the internal time (GetTime) - update the value of
 * the internal time (SetTime)
 */
