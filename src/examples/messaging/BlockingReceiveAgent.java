 ...
 * <code>blockingReceive()</code> method. Note that this method blocks the whole agent. If you call
 * it from within a behaviour you have to take into account that all other behaviours will not be
 * able to run until the call to <code>blockingReceive()</code> returns.
 * 
