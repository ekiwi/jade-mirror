...
/**
 * This example shows an agent able to respond to other agents wishing to know if it is alive. More
 * in details we use a <code>CyclicBehaviour</code> that receives only messages of type
 * <code>QUERY_IF</code> and using the <code>presence</code> ontology. All other messages are
 * ignored. This is achieved by specifying a proper <code>MessageTemplate</code>. Whenever such a
