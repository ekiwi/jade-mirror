...
/**
 * This example shows how to create a custom <code>MessageTemplate</code>. In this case we define a
 * template matching only REQUEST messages where the ontology starts with "X".
 * 
