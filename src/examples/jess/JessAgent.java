...
/**
 * This is a simple sample JADE Agent that embeds a Jess engine. It instantiates and adds only one
 * behaviour. This behaviour is BasicJessBehaviour that only asserts messages when they arrive and
 * use Jess as a reasoning tool This agent executes the Jess code in the file
 * examples/jess/JadeAgent.clp
 */
