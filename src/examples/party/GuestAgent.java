...
public class GuestAgent extends Agent {
  ...
  /**
   * Set up the agent. Register with the DF, and add a behaviour to process incoming messages. Also
   * sends a message to the host to say that this guest has arrived.
   */
  ...
  /**
   * Host is introducing this guest to the named guest. Say hello to the guest, and ask the host for
   ...
   *
   * @param agent Another guest we will send the rumour message to, but only if we know the rumour
   *        already.
   */
