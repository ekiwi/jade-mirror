...
/**
 * This is an example of an agent that plays the role of a sub-df by automatically registering with
 * a parent DF. Notice that exactly the same might be done by using the GUI of the DF.
 * <p>
 * This SUBDF inherits all the functionalities of the default DF, including its GUI.
 * 
...
public class SubDF extends jade.domain.df {
  ...
  public void setup() {
    ...
    try {
      ...
      // Execute the setup of jade.domain.df which includes all the default behaviours
      // of a df
