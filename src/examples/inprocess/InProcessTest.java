      ...
      if (args.length > 0) {
        if (args[0].equalsIgnoreCase("-container")) {
          ...
          AgentController dummy =
              ac.createNewAgent("inProcess", "jade.tools.DummyAgent.DummyAgent", new Object[0]);
          ...
          arguments[1] = dummy;
          AgentController mobile =
              another.createNewAgent("Johnny", "examples.mobile.MobileAgent", arguments);
          mobile.start();
