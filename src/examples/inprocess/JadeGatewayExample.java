...
/**
 * This class provides a simple example of a NON-jade program that connects to a running JADE-based
 * system using the JadeGateway class. In order to try this example
 * <ol>
 ...
 * <li>Open a shell and start a JADE main container typing <code>java jade.Boot -gui</code>. This
 * represents the running JADE-based system we have to connect to</li>
...
public class JadeGatewayExample {
  ...
  public static void main(String[] args) {
    ...
    // In this example we assume the Main Container of the JADE-based system we want
    // to connect
    ...
    // Now retrieve all agents active in the Main Container by running (through the
    // JadeGateway)
    // a behaviour that requests that information to the AMS. This behaviour will be
    // executed
    // by the Gateway Agent inside the JadeGateway. As soon as the execution
    // completes the execute() method
    // will return.
    try {
  ...
  /**
   * Inner class MainContainerAgentsRetriever. This behaviour requests the AMS the list of agents
   * running in the Main Container
   */
