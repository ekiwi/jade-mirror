...
public class JadeJessAgent extends jade.core.Agent // shows how Protege, JESS and JADE can be
                                                   // combined
{
  private Rete jess;
  ...
  public void setArguments(String arguments[]) // get the first argument passed to this Agent as the
                                               // key to get the
                                               // Rete engine
  {
    jess = JessHashtable.getRete(arguments[0]); // JESS should have stored a java pointer to itself
                                                // there
