...
public class JessHashtable // for storing the running JESS engine
{
  ...
  public static void setRete(String key, Rete rete) // intended to be used by JESS to store a
                                                    // pointer to itself
  {
    jessHashtable.put(key, rete);
  }

  public static Rete getRete(String key) // intended to be used by JADE behaviours to retrieve the
                                         // pointer to JESS
  {
