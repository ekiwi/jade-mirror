 ...
 * protocol. In this case in particular we use a <code>ContractNetResponder</code> to participate
 * into a negotiation where an initiator needs to assign a task to an agent among a set of
 * candidates.
 * 
