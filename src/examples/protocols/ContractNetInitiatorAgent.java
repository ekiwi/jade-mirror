 ...
 * protocol. In this case in particular we use a <code>ContractNetInitiator</code> to assign a dummy
 * task to the agent that provides the best offer among a set of agents (whose local names must be
...
public class ContractNetInitiatorAgent extends Agent {
  ...
  protected void setup() {
    ...
    if (args != null && args.length > 0) {
      ...
      System.out
          .println("Trying to delegate dummy-action to one out of " + nResponders + " responders.");
