...
/**
 * This is the GUI of the MobileAGent. Becuase in Java a new Thread is spawn for each GUI, the
 * communication with the Agent thread is based on event passing.
 */
