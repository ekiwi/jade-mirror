...
/**
 * The behaviour uses two resources, in particular the counter cnt and the flag cntEnabled, of the
 * agent object. It increments by one its value, displays it, blocks for two seconds, and repeats
 * forever.
 * 
