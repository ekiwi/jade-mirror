...
/**
 * This behaviour of the Agent serves all the received messages. In particular, the following
 * expressions are accepted as content of "request" messages: - (move <destination>) to move the
 * Agent to another container. Example (move Front-End) or (move (:location (:name Container-1)
 * (:transport-protocol JADE-IPMT) (:transport-address IOR:0000...) )) - (exit) to request the agent
