...
/*
 * This behaviour extends SimpleAchieveREInitiator in order to request to the AMS the list of
 * available locations where the agent can move. Then, it displays these locations into the GUI
 * 
...
public class GetAvailableLocationsBehaviour extends SimpleAchieveREInitiator {
  ...
  public GetAvailableLocationsBehaviour(MobileAgent a) {
    ...
    // template =
    // MessageTemplate.and(MessageTemplate.MatchOntology(MobilityOntology.NAME),template);
