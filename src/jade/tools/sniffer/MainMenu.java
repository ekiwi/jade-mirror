...
// #DOTNET_EXCLUDE_END
/*
 * #DOTNET_INCLUDE_BEGIN import System.Windows.Forms.MainMenu; import System.Windows.Forms.MenuItem;
 * #DOTNET_INCLUDE_END
 */
...
// #DOTNET_EXCLUDE_END
/*
 * #DOTNET_INCLUDE_BEGIN public class MainMenuSniffer extends MainMenu #DOTNET_INCLUDE_END
 */
{
  ...
  // #DOTNET_EXCLUDE_END
  /*
   * #DOTNET_INCLUDE_BEGIN private MenuItem menu; private MenuItem tmp; #DOTNET_INCLUDE_END
   */
  ...
  void paintM(boolean enable, SnifferAction obj) {
    ...
    // #DOTNET_EXCLUDE_END
    /*
     * #DOTNET_INCLUDE_BEGIN tmp = new MenuItem(); tmp.set_Text( obj.getActionName() );
     * tmp.add_Click( new System.EventHandler(obj.OnClick) ); tmp.set_Enabled( enable );
     * menu.get_MenuItems().Add( tmp ); #DOTNET_INCLUDE_END
     */
  }
  ...
  public MainMenu(MainWindow mainWnd, ActionProcessor actPro) {
    // #DOTNET_EXCLUDE_END
    /*
     * #DOTNET_INCLUDE_BEGIN public MainMenuSniffer(MainWindow mainWnd,ActionProcessor actPro) {
     * #DOTNET_INCLUDE_END
     */
    super();
    this.actPro = actPro;
    ...
    // #DOTNET_EXCLUDE_END
    /*
     * #DOTNET_INCLUDE_BEGIN menu = new MenuItem(); menu.set_Text("Actions"); #DOTNET_INCLUDE_END
     */
    ...
    // #DOTNET_EXCLUDE_END
    /*
     * #DOTNET_INCLUDE_BEGIN MenuItem sep = new MenuItem(); sep.set_Text( "-" );
     * menu.get_MenuItems().Add( sep ); #DOTNET_INCLUDE_END
     */
    ...
    // #DOTNET_EXCLUDE_END
    /*
     * #DOTNET_INCLUDE_BEGIN sep = new MenuItem(); sep.set_Text( "-" ); menu.get_MenuItems().Add(
     * sep ); #DOTNET_INCLUDE_END
     */
    ...
    // #DOTNET_EXCLUDE_END
    /*
     * #DOTNET_INCLUDE_BEGIN this.get_MenuItems().Add( menu ); menu = new MenuItem(); menu.set_Text(
     * "About" ); this.get_MenuItems().Add( menu ); #DOTNET_INCLUDE_END
     */
  }
