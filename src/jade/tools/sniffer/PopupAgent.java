 ...
 */
{
  ...
  // #DOTNET_EXCLUDE_END
  /*
   * #DOTNET_INCLUDE_BEGIN private MenuItem tmp; private MMCanvas canvAgent; #DOTNET_INCLUDE_END
   */
  ...
  public PopupAgent(Sniffer mySniffer, MMCanvas canvAgent) {
    ...
    // #DOTNET_EXCLUDE_END
    /*
     * #DOTNET_INCLUDE_BEGIN this.canvAgent = canvAgent; get_MenuItems().Add(popSniffAg);
     * get_MenuItems().Add(popNoSniffAg); get_MenuItems().Add(popShowAg); #DOTNET_INCLUDE_END
     */
  }
