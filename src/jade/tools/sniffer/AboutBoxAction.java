 ...
 *****************************************************************/
/**
 * This class is invoked the the user selects the AboutBox item on the menu. A dialog box appears
 * providing informations about the authors and program version. Javadoc documentation for the file
 * 
...
public class AboutBoxAction extends AbstractAction {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    f.setModal(true);
    f.setSize(360, 300);
    f.setLocation(gui.getX() + (gui.getWidth() - f.getWidth()) / 2,
        gui.getY() + (gui.getHeight() - f.getHeight()) / 2);
    f.setVisible(true);
  }
