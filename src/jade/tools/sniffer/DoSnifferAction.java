...
public class DoSnifferAction extends AgentAction {
   ...
   * 
   * @param agentName - the String name of the agent. Note, this was originally buried in doAction,
   *        but we want the ability to sniff with just a name.
   */
  ...
  private String checkString(String nameAgent) {
    ...
    if (index != -1)
      ...
      Logger.getMyLogger(this.getClass().getName()).log(Logger.WARNING,
          "The agent's name is not correct");
      return null;
    }
  }
