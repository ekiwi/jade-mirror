...
public class Agent implements Serializable {
  ...
  /**
   * This flag is <em>true</em> for agents on canvas and <em>false</em> for agents out of the
   * canvas.
   */
  ...
  /**
   * Constructor for a special agent called <em>Other</em> which represents every agent not present
   * on the Agent Canvas. It is displayed in color grey when every usual agent is displayed in color
   * red and is the first on the left.
   */
