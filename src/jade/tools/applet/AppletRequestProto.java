...
/**
 * This class implements a request protocol that can be used by an applet to comunicate with a proxy
 * agent.
 * 
...
abstract class AppletRequestProto {
  ...
  /**
   * This method can be overriden by the programmer in order to handle the notUnderstood message
   * received.
   */
  protected abstract void handleNotUnderstood(ACLMessage msg);

  /**
   * This method can be overriden by the programmer in order to handle the message not stated by the
   * protocol eventually received.
   */
   ...
   */
  static Result extractContent(String content, SLCodec c, Ontology o)
