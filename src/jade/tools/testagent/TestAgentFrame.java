...
public class TestAgentFrame extends JFrame {
  ...
  public void getImages() {
    ...
    try {
      newIcon = new ImageIcon(this.getClass().getResource("images/new.gif"));
      openIcon = new ImageIcon(this.getClass().getResource("images/open.gif"));
      saveIcon = new ImageIcon(this.getClass().getResource("images/save.gif"));
      sendIcon = new ImageIcon(this.getClass().getResource("images/send.gif"));
      readQueueIcon = new ImageIcon(this.getClass().getResource("images/readqueue.gif"));
      saveQueueIcon = new ImageIcon(this.getClass().getResource("images/writequeue.gif"));
      currentIcon = new ImageIcon(this.getClass().getResource("images/current.gif"));
      replyIcon = new ImageIcon(this.getClass().getResource("images/reply.gif"));
      viewIcon = new ImageIcon(this.getClass().getResource("images/inspect.gif"));
      deleteIcon = new ImageIcon(this.getClass().getResource("images/delete.gif"));
      statisticsIcon = new ImageIcon(this.getClass().getResource("images/book.gif"));
      quitIcon = new ImageIcon(this.getClass().getResource("images/quit.gif"));
      systemIcon = new ImageIcon(this.getClass().getResource("images/system.gif"));
    } catch (Exception ex) {
      ex.printStackTrace();
    }
  ...
  private void jbInit() throws Exception {
    ...
    helloWorldMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    amsRegMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    amsDeregMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    amsSearchMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    pingLausanneMenuItem
        .setToolTipText("Ping to Lausannes PingAgent (works only when http package installed)");
    pingLausanneMenuItem.setMnemonic('P');
    pingLausanneMenuItem.setText("Ping to Lausanne ");
    pingLausanneMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    dfSearchMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    dfRegMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    dfDeregMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    writeQueueButton.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    claerQueueMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    loadMsgMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    saveMsgMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    loadQMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    systemOutMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    currentToOutMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    pingRadioButtonMenuItem.addChangeListener(new javax.swing.event.ChangeListener() {
      public void stateChanged(ChangeEvent e) {
        pingRadioButtonMenuItem_stateChanged(e);
      }
    });
    localPingMenuItem.addActionListener(new java.awt.event.ActionListener() {
      public void actionPerformed(ActionEvent e) {
    ...
    leftPanel.add(aclPanel, new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
  ...
  private class AboutFrame extends JWindow {
    ...
    private void jbInit() throws Exception {
      ...
      border1 =
          new TitledBorder(BorderFactory.createLineBorder(new Color(0, 0, 128), 1), "TestAgent");
      this.getContentPane().setBackground(Color.white);
      this.getContentPane().setLayout(gridBagLayout1);
