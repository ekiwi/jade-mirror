...
/**
 * DummyAgentAction spawns an external application passing as parameters a String containing ALL
 * agents selected in the Tree
 * 
...
class IntrospectorAction extends ContainerAction {
  ...
  public void doAction(AgentTree.ContainerNode node) {
    ...
    myRMA.newAgent("Introspector" + progressiveNumber, "jade.tools.introspector.Introspector",
        new Object[0], containerName);
    progressiveNumber++;
  }
