...
/**
 * <em>Remote Management Agent</em> agent. This class implements <b>JADE</b> <em>RMA</em> agent.
 * <b>JADE</b> applications cannot use this class directly, but interact with it through
 * <em>ACL</em> message passing. Besides, this agent has a <em>GUI</em> through which <b>JADE</b>
 * Agent Platform can be administered.
 * 
 * 
...
public class rma extends ToolAgent {
  ...
  /**
   * This method starts the <em>RMA</em> behaviours to allow the agent to carry on its duties within
   ...
   * Callback method for platform management <em>GUI</em>.
   */
  public void newAgent(String agentName, String className, Object arg[], String ownerName,
    ...
    if ((ownerName == null) || (ownerName.trim().length() == 0)) {
      ...
      try {
        ...
        java.lang.reflect.Method setName =
            c.getDeclaredMethod("setName", new Class[] {String.class});
  ...
  public void addRemotePlatformFromURL(String url) {
    ...
    try {
      ...
      String content =
          "(( result (action ( agent-identifier :name ams :addresses (sequence IOR:00000000000000) :resolvers (sequence ) ) (get-description ) ) (sequence "
              + buf.toString() + " ) ) )";
