...
class MainWindow extends JFrame {
  ...
  public MainWindow(rma anRMA) {
    ...
    temp.setIcon(null);
    temp =
        popupRemote.add((RMAAction) actPro.actions.get(actPro.REGISTERREMOTEAGENTWITHAMS_ACTION));
    temp.setIcon(null);
    ...
    JMenuItem tmp =
        popLocalPlatform.add((RMAAction) actPro.actions.get(actPro.VIEWPLATFORM_ACTION));
    tmp.setIcon(null);
  ...
  public void addAgent(final String containerName, final AID agentID, final String state,
  ...
  public void modifyAgent(final String containerName, final AID agentID, final String state,
      final String ownership) {
  ...
  public void modifyFrozenAgent(final String oldContainer, final String newContainer,
      final AID agentID) {
  ...
  public void modifyThawedAgent(final String oldContainer, final String newContainer,
      final AID agentID) {
  ...
  public void refreshRemoteAgentsInRemotePlatform(final APDescription platform,
      final Iterator remoteAgents) {
  ...
  public void showErrorDialog(String text, ACLMessage msg) {
    ...
    int answer = JOptionPane.showConfirmDialog(this, messages, "RMA Error !!!",
  ...
  public boolean showUninstallMTPDialog(jade.domain.JADEAgentManagement.UninstallMTP umtp) {
    ...
    String address = (String) JOptionPane.showInputDialog(this, "Choose the MTP to remove.",
        "Remove an MTP", JOptionPane.INFORMATION_MESSAGE, null, names, names[0]);
    if (address != null) {
