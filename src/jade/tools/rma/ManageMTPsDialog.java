...
public class ManageMTPsDialog extends JDialog {
  ...
  private AbstractAction removeMTPAction = new AbstractAction("Remove MTP") {
    ...
    public void actionPerformed(ActionEvent ev) {
      int option = JOptionPane.showConfirmDialog(ManageMTPsDialog.this,
          "Are you sure you want to remove the selected MTP?", "Removing MTP",
  ...
  private void initComponents() {// GEN-BEGIN:initComponents
    ...
    lists.setBorder(new CompoundBorder(new EmptyBorder(new Insets(5, 5, 5, 5)), new CompoundBorder(
        new BevelBorder(BevelBorder.LOWERED), new EmptyBorder(new Insets(5, 5, 5, 5)))));
