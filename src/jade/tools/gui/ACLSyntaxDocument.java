...
/**
 * The interface a document must implement to be colorizable by the jEdit text area component. The
 * original file is written by Slava Pestov (www.gjt.org) and altered to fit ACL/SL.
 *
