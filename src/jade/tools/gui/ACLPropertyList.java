...
public class ACLPropertyList extends JPanel {
  ...
  /**
   * Adds a feature to the Button_actionPerformed attribute of the ACLPropertyList object
   *
  ...
  private class ACLPropertyListCellRenderer extends JLabel implements ListCellRenderer {
    ...
    /**
     * Gets the ListCellRendererComponent attribute of the ACLPropertyListCellRenderer object
     *
     * @param list the list
  ...
  private ACLPropertyListCellRenderer aclPropertyListCellRenderer =
      new ACLPropertyListCellRenderer();
