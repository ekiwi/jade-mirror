 ...
 * The original file is written by Slava Pestov (www.gjt.org) and altered to fit ACL/SL.
 *
...
public class ACLSytntaxStyle {
  ...
  public Font getStyledFont(Font font) {
    ...
    lastStyledFont = new Font(font.getFamily(),
        (bold ? Font.BOLD : 0) | (italics ? Font.ITALIC : 0), font.getSize());
    return lastStyledFont;
  }
  ...
  public String toString() {
    return getClass().getName() + "[color=" + color + (italics ? ",italics" : "")
        + (bold ? ",bold" : "") + "]";
  }
