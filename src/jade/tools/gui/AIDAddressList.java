...
public class AIDAddressList extends JPanel {
  ...
  public void doView() {
    ...
    theDialog
        .setTitle(editable ? "Edit address: " + currentAddress : "View address:" + currentAddress);
  ...
  /**
   * Adds a feature to the Button_actionPerformed attribute of the AIDAddressesList object
   *
  ...
  private void jbInit() throws Exception {
    ...
    this.add(addButton, new GridBagConstraints(1, 2, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER,
        GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
    this.add(deleteButton, new GridBagConstraints(1, 3, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER,
        GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
    this.add(viewButton, new GridBagConstraints(1, 1, 1, 1, 0.0, 1.0, GridBagConstraints.SOUTHEAST,
        GridBagConstraints.VERTICAL, new Insets(0, 0, 0, 0), 0, 0));
  }
  ...
  /**
   * This class show a dialog where the address of an AID can be viewed and edited.
   *
   * @author Chris van Aart - Acklin B.V., the Netherlands
   * @created April 26, 2002
   */
