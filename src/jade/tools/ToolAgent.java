 ...
 * It provides suitable behaviours to interact with the AMS, registering for interesting events and
...
public abstract class ToolAgent extends Agent {
  ...
  /**
   * This method is invoked just after the generic agent setup. Subclasses must use this method the
   * same way ordinary agents use their <code>setup()</code> method.
   */
  ...
  /**
   * This method is invoked just before the generic agent takedown. Subclasses must use this method
   * the same way ordinary agents use their <code>takeDown()</code> method.
   */
  ...
  /**
   * Retrieve the <code>subscribe</code> ACL message with which this tool agent subscribed with the
   * AMS.
   * 
  ...
  /**
   * Retrieve the <code>cancel</code> ACL message with which this tool agent removes its
   * subscription with the AMS.
   * 
  ...
  /**
   * Retrieve the <code>request</code> ACL message with which this tool agent requests the AMS
  ...
  private void init() {
    ...
    try {
      ...
      logger.log(Logger.WARNING,
          "NotificationService not installed. Some tool may not work properly.");
    }
  }
