...
public class ContainerLogWindow extends JInternalFrame implements InternalFrameListener {
  ...
  public ContainerLogWindow(Agent a, String containerName, AID controller, LogManager logManager,
      LogManagerGUI gui) throws FIPAException {
    super(containerName);
  ...
  private class LogTable extends AbstractTableModel {
    ...
    public void setValueAt(Object value, int row, int column) {
      ...
      try {
        ...
        int res = JOptionPane.showConfirmDialog(mainGui,
            "Cannot set " + getColumnName(column) + " to logger " + info.getName()
