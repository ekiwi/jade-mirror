...
public class LogHelperAgent extends Agent {
  ...
  private String logManagerClass = JavaLoggingLogManagerImpl.JAVA_LOGGING_LOG_MANAGER_CLASS; // default
                                                                                             // logManagerClass
                                                                                             // if
                                                                                             // not
                                                                                             // specified.
  ...
  private class LogHelperAgentBehaviour extends SimpleAchieveREResponder {
    ...
    private void handleGetAllLoggers(GetAllLoggers action, Action actExpr, ACLMessage reply)
        throws FailureException {
      try {
    ...
    private void handleSetFile(SetFile action, Action actExpr, ACLMessage reply)
        throws FailureException {
      if (logManager != null) {
    ...
    private void handleSetLevel(SetLevel action, Action actExpr, ACLMessage reply)
        throws FailureException {
      if (logManager != null) {
