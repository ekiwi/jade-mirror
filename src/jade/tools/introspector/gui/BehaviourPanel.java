...
/**
 * This panel contains the behaviour tree for a given agent. It adds a TreeMouseListener component
 * to the tree.
 * 
...
public class BehaviourPanel extends JSplitPane {
  ...
  public void build() {
    ...
    // readyIcon = new
    // ImageIcon(getClass().getResource("images"+java.io.File.separator+"behaviour.gif"));
    // blockedIcon = new
    // ImageIcon(getClass().getResource("images"+java.io.File.separator+"blocked.gif"));
    // runningIcon = new
    // ImageIcon(getClass().getResource("images"+java.io.File.separator+"running.gif"));
  ...
  /**
   * The BehaviourCellRenderer class manages rendering nodes in the behaviour tree.
   */
