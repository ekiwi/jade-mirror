...
/**
 * This class represents a tree node for a behaviour in the Introspector GUI. It maintains the state
 * of the behaviour.
 * 
...
public class BehaviourTreeNode {
  ...
  /*
   * public BehaviourTreeNode(BehaviourID beh, boolean bl) { behaviour = beh; blocked = bl; }
   * 
