...
/**
 * Listener class for the popup menu associated ti the message table. It allows to insert, remove
 * and show a message in the message table. Presentely, only the 'view' option is implemented,
 * because the 'add' and 'remove' option would need a modifications to the agent message queue class
 * to be implemented.
 * 
