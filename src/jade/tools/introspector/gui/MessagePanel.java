...
public class MessagePanel extends JPanel {
  ...
  public MessagePanel(MessageTableModel in1, MessageTableModel in2, MessageTableModel out1,
      MessageTableModel out2) {
    super();
    inPending = in1;
    inDone = in2;
    outPending = out1;
  ...
  public void build() {
    ...
    incoming.setBorder(BorderFactory.createTitledBorder(line, "Incoming Messages",
        TitledBorder.CENTER, TitledBorder.TOP));
    incoming.add(inScrollPending, "Pending");
    incoming.add(inScrollDone, "Received");
    outgoing.setBorder(BorderFactory.createTitledBorder(line, "Outgoing Messages",
        TitledBorder.CENTER, TitledBorder.TOP));
