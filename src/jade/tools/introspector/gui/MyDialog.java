...
public class MyDialog extends JDialog implements ActionListener, WindowListener {
  ...
  private void jbInit() throws Exception {
    ...
    panel1.add(panel2, new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
        GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
    panel2.add(jTextField1, BorderLayout.NORTH);
    panel1.add(jPanel1, new GridBagConstraints(0, 1, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER,
