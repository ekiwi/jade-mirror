...
public interface ACLParserConstants {
  ...
  String[] tokenImage = {"<EOF>", "\" \"", "\"\\t\"", "\"\\n\"", "\"\\r\"", "\"(\"", "\" \"",
      "\"\\t\"", "\"\\n\"", "\"\\r\"", "<MESSAGETYPE>", "\" \"", "\"\\t\"", "\"\\n\"", "\"\\r\"",
      "\":sender\"", "\":receiver\"", "\":content\"", "\":reply-with\"", "\":reply-by\"",
      "\":in-reply-to\"", "\":reply-to\"", "\":encoding\"", "\":language\"", "\":ontology\"",
      "\":protocol\"", "\":conversation-id\"", "<USERDEFINEDPARAM>", "\")\"", "\" \"", "\"\\t\"",
      "\"\\n\"", "\"\\r\"", "<DATETIME>", "<WORD>", "<STRINGLITERAL>", "<DIGIT>", "<INTEGER>",
      "<FLOATONE>", "<FLOATTWO>", "<PREFIXBYTELENGTHENCODEDSTRING>", "\")\"", "\"(\"", "\" \"",
      "\"\\t\"", "\"\\n\"", "\"\\r\"", "\"set\"", "\"sequence\"", "\"agent-identifier\"",
      "\":name\"", "\":addresses\"", "\":resolvers\"", "<USERDEFINEDSLOT>", "\")\"", "\"(\"",};
