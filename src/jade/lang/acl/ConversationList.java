...
/**
 * This class represents a list of conversations that an agent is currently carrying out and allows
 * creating a <code>MessageTemplate</code> that matches only messages that do not belong to any of
 * these conversations.
 */
public class ConversationList implements Serializable {
  ...
  /**
   * Return a template that matches only messages that do not belong to any of the conversations in
   * this list.
   */
