...
public class LEAPCodec extends ByteArrayCodec {
  ...
  /*
   * LEAP Language operators public static final String INSTANCEOF = "INSTANCEOF"; public static
   * final String INSTANCEOF_ENTITY = "entity"; public static final String INSTANCEOF_TYPE = "type";
   * 
   ...
   * @throws CodecException
   */
  public synchronized AbsContentElement decode(Ontology ontology, byte[] content)
      throws CodecException {
    if (content.length == 0) {
      return null;
    }
