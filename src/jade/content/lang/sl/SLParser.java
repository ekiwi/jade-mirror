...
class SLParser implements SLParserConstants {
  ...
  /**
   * By default an object of this type implements a Full SLParser. This method allows to change this
   * default.
   * 
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println(
          "usage: SLParser SLLevel\u005cn  where SLLevel can be 0 for SL0, 1 for SL1, 2 for SL2, 3 or more for full SL");
      System.exit(0);
    }
    ...
    while (true) {
      ...
      try {
        ...
        System.out.println(
            "\u005cn\u005cn RESULT of SLCodec.decode(SLCodec.encode(SLParser.Content()))=\u005cn"
  ...
  private static void jj_la1_init_0() {
    jj_la1_0 = new int[] {0x843020, 0x800020, 0x1000040, 0x843020, 0xee003000, 0x56003000, 0x873fa0,
        0x33f00, 0x87ffa0, 0x10003000, 0x873fa0, 0xc000, 0x87ffa0, 0xc000, 0x42000000, 0x840020,
        0x843020, 0x843020, 0x873fa0, 0xa8003000, 0xf00, 0x3000, 0x40000,};
  }

  private static void jj_la1_init_1() {
    jj_la1_1 = new int[] {0x1c, 0x0, 0x0, 0x1c, 0xf, 0xc, 0x1c, 0xc, 0x1c, 0xc, 0x1c, 0x0, 0x1c,
        0x0, 0x0, 0x10, 0x1c, 0x1c, 0x1c, 0xf, 0x0, 0xc, 0x10,};
  }
