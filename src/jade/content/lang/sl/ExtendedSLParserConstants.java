...
public interface ExtendedSLParserConstants {
  ...
  String[] tokenImage = {"<EOF>", "\" \"", "\"\\t\"", "\"\\n\"", "\"\\r\"", "\"(\"", "\")\"",
      "<VARIABLE>", "<INTEGER>", "<HEXINTEGER>", "<LONG>", "<FLOATONE>", "<FLOATTWO>", "<FLOAT>",
      "<WORD>", "<STRING_LITERAL>", "<PARAMETERNAME>", "<PARAMETERNAME_STRING>", "<DATETIME>",
      "<PREFIXBYTELENGTHENCODEDSTRING>", "<METASYMBOL>", "\" \"", "\"\\t\"", "\"\\n\"", "\"\\r\"",
      "\"(\"", "\")\"", "\"action\"", "<REFERENTIALOP>", "<MODALOP>", "<ARITHMETICOP>",
      "<ACTIONOP>", "<ACTIONOPLL>", "\"not\"", "<BINARYLOGICALOP>", "<QUANTIFIER>", "<WORD2>",
      "<STRING_LITERAL2>", "<METASYMBOL2>",};
