...
class ExtendedSLParser implements ExtendedSLParserConstants {
  ...
  /*
   * Take a quoted FIPA SL0 String and convert to a normal Java-style String. Remove the
   * leading/trailing quotation marks, and un-escape any included quotation marks. This must be the
   * exact inverse of the escape() procedure in the SLEncoder.
   */
  ...
  /**
   * When an ActionExpression is parsed, if it is an AbsConcept then it must be casted upto an
   * AbsAgentAction.
   **/
  ...
  /**
   * By default an object of this type implements a Full ExtendedSLParser. This method allows to
   * change this default.
   * 
   ...
   * @param o the ontology, null if no ontology (this parameter is used to get the names of the
   *        slots when they are encoded as unnamed slots.
   */
   ...
   * @param o the ontology, null if no ontology (this parameter is used to get the names of the
   *        slots when they are encoded as unnamed slots.
   * @deprecated since JADE 3.4 it is preferrable to use reinit() and then call directly the method
   *             corresponding to the production rule (e.g. Content())
   */
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println(
          "usage: ExtendedSLParser SLLevel\u005cn  where SLLevel can be 0 for SL0, 1 for SL1, 2 for SL2, 3 or more for full SL");
      System.exit(0);
    }
    ...
    while (true) {
      ...
      try {
        ...
        System.out
            .println("\u005cn\u005cn RESULT of ExtendedSLParser.Content()=\u005cn" + resultEncoded);
        AbsContentElement result2 = codec.decode(resultEncoded);
        System.out.println(
            "\u005cn\u005cn RESULT of SLCodec.decode(SLCodec.encode(ExtendedSLParser.Content()))=\u005cn"
  ...
  /**
   * This production rule represents the more general expression that can serve as content for an
   * ACL message. Since different communicative acts have different content (action expressions for
   * <code>request</code>, predicate for <code>inform</code>, etc.), any allowed SL content
      ...
      case PREFIXBYTELENGTHENCODEDSTRING:
        ...
        try {
        ...
        } catch (UnsupportedEncodingException uee) {
          {
            if (true)
              throw new ParseException(
                  "Error decoding byte-array from Base64 US-ASCII, " + uee.getMessage());
          }
        }
        break;
      default:
  ...
  /**
   * This grammar rule is an extension to the FIPA SL Grammar. It is specific to the semantics
   * framework. It allows to represent a symbol which is not matched by any FIPA-SL token.
   **/
  ...
  private static void jj_la1_init_0() {
    jj_la1_0 =
        new int[] {0x210c020, 0x2000020, 0x4000040, 0x210c020, 0xb800c000, 0x5800c000, 0x21cffa0,
            0xcff00, 0x21fffa0, 0x4000c000, 0x21cffa0, 0x30000, 0x21fffa0, 0x30000, 0x8000000,
            0x2100020, 0x210c020, 0x210c020, 0x21cffa0, 0xa000c000, 0x3f00, 0xc000, 0x100000,};
  }

  private static void jj_la1_init_1() {
    jj_la1_1 = new int[] {0x70, 0x0, 0x0, 0x70, 0x3f, 0x31, 0x70, 0x30, 0x70, 0x30, 0x70, 0x0, 0x70,
        0x0, 0x1, 0x40, 0x70, 0x70, 0x70, 0x3e, 0x0, 0x30, 0x40,};
  }
