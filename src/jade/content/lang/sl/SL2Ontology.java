...
/**
 * Ontology containing schemas for the SL2 language operators. see jade.content.Ontology
 * 
...
class SL2Ontology extends SL1Ontology implements SL2Vocabulary {
  ...
  private static Ontology theInstance =
      new SL2Ontology(ONTOLOGY_NAME, SL1Ontology.getInstance(), null);
  ...
  protected SL2Ontology(String name, Ontology base, Introspector intro) {
    ...
    try {
      ...
      ps.add(FEASIBLE_CONDITION, (PredicateSchema) PredicateSchema.getBaseSchema(),
