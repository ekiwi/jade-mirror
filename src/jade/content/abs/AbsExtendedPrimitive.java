...
public class AbsExtendedPrimitive implements AbsTerm {
  ...
  /**
   * Construct an extended abstract descriptor to hold a primitive of the proper type (e.g.
   * java.math.BigDecimal...) and set its value.
   */
   ...
   * 
   * @param typeName The name of the type of the extended-primitive held by this descriptor.
   */
  ...
  /**
   * Create an AbsExtendedPrimitive of type <code>value.getClass()</code> containing a given value.
   */
   ...
   * @throws IllegalArgumentException If the type of this AbsExtendedPrimitive is not correct.
   */
  ...
  /**
   * Makes no sense in the case of an AbsExtendedPrimitive that has no attribute --> Just return
   * null
   */
