...
public class AbsVariable extends AbsObjectImpl implements AbsTerm {
  ...
  /**
   * Return true if this object represents a meta term (i.e. symbol ??x) rather than a concrete
   * variable. This method is currently used only by the semantics framework.
   * 
  ...
  /**
   * Sets the value of isMetaTerm, where the default is false. This method is currently used only by
