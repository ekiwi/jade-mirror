...
public class AbsPredicate extends AbsPrimitiveSlotsHolder implements AbsContentElement, Predicate {
  ...
  /**
   * Construct an Abstract descriptor to hold a predicate of the proper type (e.g. FATHER_OF,
   * WORKS_FOR...).
   * 
   * @param typeName The name of the type of the predicate held by this abstract descriptor.
   */
  ...
  /**
   * Gets the value (casted as an AbsTerm) of an attribute of the predicate held by this abstract
   * descriptor. This method is here mainly for backward compatibility.
   * 
  ...
  /**
   * Return true if this object represents a meta formula (symbol ??x) rather than a concrete
   * formula. This method is currently used only by the semantics framework.
   * 
  ...
  /**
   * Sets the value of isMetaFormula, where the default is false. This method is currently used only
   * by the semantics framework.
   * 
   * @since JADE3.4
   **/
