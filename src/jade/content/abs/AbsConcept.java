...
public class AbsConcept extends AbsPrimitiveSlotsHolder implements AbsTerm, Concept {
  ...
  /**
   * Construct an Abstract descriptor to hold a concept of the proper type (e.g. PERSON,
   * ADDRESS...).
   * 
   * @param typeName The name of the type of the concept held by this abstract descriptor.
   */
