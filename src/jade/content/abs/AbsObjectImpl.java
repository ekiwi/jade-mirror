...
/**
 * Base class for all non-primitive abstract descriptor classes. This class is not intended to be
 * used by programmers.
 * 
...
public class AbsObjectImpl implements AbsObject {
   ...
   * @param value The new value of the attribute. If <code>value</code> is null the current mapping
   *        with <code>name</code> (if any) is removed.
   */
  ...
  /**
   * Tests if the object is grounded, i.e., if no one of its attributes is associated with a
   * variable
   * 
  ...
  /**
   * This method is here just for debugging. Notice that it is highly innefficient. The method
   * StringCodec.encode() should be used instead.
   * 
  ...
  /**
   * Returns true if the attribute is equal to this abstract descriptor, based on the contents of
   * both descriptors.
   */
  ...
  /**
   * Calculates the hashcode according to a formula based on the slot names and values taken in an
