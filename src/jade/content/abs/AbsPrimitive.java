...
public class AbsPrimitive implements AbsTerm {
  ...
  /**
   * Construct an Abstract descriptor to hold a primitive of the proper type (e.g. String, int,
   * boolean...) and set its value.
   */
   ...
   * boolean...).
   * 
   * @param typeName The name of the type of the primitive held by this abstract descriptor.
   */
  ...
  /**
   * Create an AbsPrimitive of type <code>BasicOntology.STRING</code> containing a given
  ...
  /**
   * Create an AbsPrimitive of type <code>BasicOntology.BOOLEAN</code> containing a given
  ...
  /**
   * Create an AbsPrimitive of type <code>BasicOntology.INTEGER</code> containing a given
   * <code>int</code> value.
   */
  ...
  // #MIDP_EXCLUDE_BEGIN
  /**
   * Create an AbsPrimitive of type <code>BasicOntology.FLOAT</code> containing a given
  ...
  /**
   * Create an AbsPrimitive of type <code>BasicOntology.DATE</code> containing a given
  ...
  /**
   * Create an AbsPrimitive of type <code>BasicOntology.BYTE_SEQUENCE</code> containing a given
  ...
  /**
   * @return the value of this AbsPrimitive as an Object. If the type of this AbsPrimitive is
   *         <code>BasicOntology.BOOLEAN
   * BasicOntology.INTEGER or BasicOntology.FLOAT</code> a <code>Boolean, Integer or Float</code>
   *         object is returned.
   */
