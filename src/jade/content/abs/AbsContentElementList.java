...
public class AbsContentElementList implements AbsContentElement {
  ...
  /**
   * @return An <code>Iterator</code> over the elements of this content element list.
   */
   ...
   * 
   * @return <code>true</code> if the given content element is contained in this content element
   *         list.
   */
   ...
   * 
   * @return The position of an element within this content element list or -1 if the given element
   *         is not contained in this content element list.
   */
   ...
   * 
   * @return <code>true</code> if this content element list does not contain any element.
   */
  ...
  /**
   * Makes no sense in the case of an AbsContentElementList that has no attribute --> Just return
   * null
   */
  ...
  /**
   * Return the number of elements in the list. Is equivalent to <code>size()</code>
   */
  public int getCount() {
    return size();
  }
