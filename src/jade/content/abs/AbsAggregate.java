...
public class AbsAggregate extends AbsConcept {
  ...
  /**
   * Construct an Abstract descriptor to hold an aggregate of the proper type (i.e. SET,
   * SEQUENCE...).
   * 
   * @param typeName The name of the type of the aggregate held by this abstract descriptor.
   */
   ...
   * 
   * @throws IllegalArgumentException if name is not of the form Codec.UNNAMEDPERFIX+index
   */
  ...
  /**
   * Tests if this AbsAggregate is grounded, i.e., if no one of its elements is associated with a
   * variable
   * 
