...
public class ContentElementListSchema extends ContentElementSchema {
  ...
  /**
   * Construct a schema that vinculates an entity to be a content element list. Note that there are
   * no different types of content element list as it happens for concepts (e.g. Person,
   * Address...), IREs (e.g. IOTA, ANY, ALL...) and the like. Therefore there is no
   * ContentElementListSchema constructor that takes a String parameter.
   */
