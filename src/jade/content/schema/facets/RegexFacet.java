...
/**
 * This facet forces an AbsPrimitive to contain a specific set of values expressed as a regular
 * expression.
 */
public class RegexFacet implements Facet {
  ...
  /**
   * Construct a <code>PermittedValuesFacet</code> that forces an AbsPrimitive to contain a specific
   * set of values expressed as a regular expression
   */
