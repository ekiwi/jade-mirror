...
/**
 * This facet forces an AbsAggregate to contain a number of elements that is comprised between a
 * given min and a given max.
 * 
...
public class CardinalityFacet implements Facet {
  ...
  /**
   * Construct a <code>CardinalityFacet</code> that forces the number of elements in an AbsAggregate
  ...
  public void validate(AbsObject value, Ontology onto) throws OntologyException {
    ...
    if (size < cardMin) {
      throw new OntologyException(
          value + " includes less elements than required (" + cardMin + ")");
    }
