...
public class AggregateSchema extends TermSchema {
  ...
  /**
   * The difference between types of aggregates (such as SET and SEQUENCE) is quite fuzy. Therefore
   * we don't throw a validation exception if a SET is found where a SEQUENCE is expected and VV.
   */
  ...
  public boolean isAssignableFrom(ObjectSchema s) {
    if (s != null && s instanceof AggregateSchema && s.getTypeName().equals(getTypeName())) {
