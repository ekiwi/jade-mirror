...
public class ConceptSchema extends TermSchema {
  ...
  /**
   * Creates a <code>ConceptSchema</code> with a given type-name, e.g. PERSON, ADDRESS...
   * 
  ...
  /**
   * Add a mandatory slot to the schema. The schema for this slot must be a <code>TermSchema</code>.
   * 
  ...
  /**
   * Add a slot to the schema. The schema for this slot must be a <code>TermSchema</code>.
   * 
   * @param name The name of the slot.
   * @param slotSchema The schema of the slot.
   ...
   */
  public void add(String name, ObjectSchema elementsSchema, int cardMin, int cardMax,
      String aggType, int optionality) {
    super.add(name, elementsSchema, cardMin, cardMax, aggType, optionality);
  }

  /**
   * Adds a super-schema to this schema. This allows defining inheritance relationships between
   * ontological concepts. It must be noted that a concept always inherits from another concept -->
   * A super-schema of a <code>ConceptSchema</code> must be a <code>ConceptSchema</code> too.
   *
