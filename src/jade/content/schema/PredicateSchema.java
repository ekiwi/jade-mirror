...
public class PredicateSchema extends ContentElementSchema {
  ...
  /**
   * Creates a <code>PredicateSchema</code> with a given type-name, e.g. FATHER_OF, WORKS_FOR...
   * 
   ...
   * ontological predicates. It must be noted that a predicate always inherits from another
   * predicate --> A super-schema of a <code>PredicateSchema</code> must be a
   * <code>PredicateSchema</code> too.
   *
