 ...
 * agent and to fill and extract the content of an ACL message according to a given content language
 * and ontology. Each agent has a <code>ContentManager</code> object accessible through the
...
public class ContentManager implements Serializable {
  ...
  /**
   * Registers a <code>Codec</code> for a given content language with its default name (i.e. the
   * name returned by its <code>getName()</code> method. Since this operation is performed the agent
   * that owns this <code>ContentManager</code> is able to "speak" the language corresponding to the
   * registered <code>Codec</code>.
   * 
  ...
  /**
   * Registers a <code>Codec</code> for a given content language with a given name.
   * 
   * @param c the <code>Codec</code> to be registered.
  ...
  /**
   * Registers an <code>Ontology</code> with its default name (i.e. the name returned by its
   * <code>getName()</code> method. Since this operation is performed the agent that owns this
   * <code>ContentManager</code> "knows" the registered <code>Ontology</code>.
   * 
  ...
  /**
   * Retrieves a previously registered <code>Codec</code> giving its <code>name</code>.
   * 
   * @param name the name associated to the <code>Codec</code> to be retrieved.
   * @return the <code>Codec</code> associated to <code>name</code> or <code>null</code> if no Codec
  ...
  /**
   * Retrieves a previously registered <code>Ontology</code> giving its <code>name</code>.
   * 
   * @param name the name associated to the <code>Ontology</code> to be retrieved.
   * @return the <code>Ontology</code> associated to <code>name</code> or <code>null</code> if no
   *         Ontology was registered with the given name.
   */
  ...
  /**
   * Fills the <code>:content</code> slot of an <code>ACLMessage msg</code> using the content
   * language and ontology indicated in the <code>:language</code> and <code>:ontology</code> fields
   * of <code>msg</code>.
   * 
   * @param msg the message whose content has to be filled.
   * @param content the content of the message represented as an <code>AbsContentElement</code>.
   * @throws CodecException if <code>content</code> is not compliant to the content language used
   *         for this operation.
   * @throws OntologyException if <code>content</code> is not compliant to the ontology used for
   *         this operation.
   */
   ...
   * 
   * @param msg the message whose content has to be filled.
   * @param content the content of the message represented as a <code>ContentElement</code>.
   * @throws CodecException if <code>content</code> is not compliant to the content language used
   *         for this operation.
   * @throws OntologyException if <code>content</code> is not compliant to the ontology used for
   *         this operation.
  ...
  /**
   * Translates the <code>:content</code> slot of an <code>ACLMessage msg</code> into an
   * <code>AbsContentElement</code> using the content language and ontology indicated in the
   * <code>:language</code> and <code>:ontology</code> fields of <code>msg</code>.
   * 
   * @param msg the message whose content has to be extracted.
   * @return the content of the message represented as an <code>AbsContentElement</code>.
   * @throws CodecException if the content of the message is not compliant to the content language
   *         used for this operation.
   * @throws OntologyException if the content of the message is not compliant to the ontology used
   *         for this operation.
   */
  ...
  /**
   * Translates the <code>:content</code> slot of an <code>ACLMessage msg</code> into a
   * <code>ContentElement</code> using the content language and ontology indicated in the
   * <code>:language</code> and <code>:ontology</code> fields of <code>msg</code>.
   * 
   * @param msg the message whose content has to be extracted.
   * @return the content of the message represented as a <code>ContentElement</code>.
   * @throws CodecException if the content of the message is not compliant to the content language
   *         used for this operation.
   * @throws OntologyException if the content of the message is not compliant to the ontology used
   *         for this operation.
  ...
  /**
   * Set the validation mode i.e. whether contents that are managed by this content manager should
   * be validated during message content filling/extraction. Default value is <code>true</code>
   * 
  ...
  /**
   * Return the currently set validation mode i.e. whether contents that are managed by this content
   * manager should be validated during message content filling/extraction. Default value is
   * <code>true</code>
   * 
