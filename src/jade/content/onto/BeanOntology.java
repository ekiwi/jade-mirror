...
/**
 * Extension of <code>Ontology</code> that allows to build the ontological elements adding directly
 * the classes of the corresponding JavaBeans. The <code>BeanOntology</code> internally needs to use
 * its introspector <code>BeanIntrospector</code>. A typical pattern to create an ontology extending
 * the <code>BeanOntology</code> is the following:
 *
 * <p>
 * <blockquote>
 * 
 ...
 * </p>
 *
 * The ontology <code>MyOntology</code> will be built creating the hierarchy of ontological items
 * defined by the beans in package <code>com.acme.rocket.ontology</code> plus the two beans
 * <code>C1</code> and <code>C2</code>. An ontological bean is a class implementing either
...
public class BeanOntology extends Ontology {
  ...
  /**
   * Create an Ontology with the given <code>name</code>. The <code>BasicOntology</code> is
   * automatically added as the base ontology.
   *
  ...
  /**
   * Create an Ontology with the given <code>name</code> that extends the ontology
   * <code>base</code>, which must have <code>BasicOntology</code> in its hierarchy.
   *
   * @param name The identifier of the ontology.
  ...
  /**
   * Create an Ontology with the given <code>name</code> that extends the <code>base</code> set of
   * ontologies. At least one of the <code>base</code> ontologies must extend the ontology
  ...
  /**
   * Adds to the ontology the schema built from the class <code>clazz</code>. The class must
   * implement either <code>Concept</code> or <code>Predicate</code>.
   *
  ...
  /**
   * Adds all the ontological beans (the ones which implement either <code>Concept</code> or
   * <code>Predicate</code>) found in the specified package.
   *
   ...
   * 
   * @param clazz class from which to build the ontological schema
   * @param buildHierarchy if <code>true</code>, build the full hierarchy ontological elements.
   *        Otherwise, build a set of flat unrelated elements
   * @throws BeanOntologyException
   */
