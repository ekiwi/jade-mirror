...
/**
 * The default introspector for user defined ontologies that uses Java Reflection to translate java
 * objects to/from abstract descriptors. <br>
  ...
  protected Object invokeAccessorMethod(Method method, Object obj) throws OntologyException {
    try {
      ...
      throw new OntologyException(
          "Error invoking accessor method " + method.getName() + " on object " + obj, e);
    }
  }
  // #APIDOC_EXCLUDE_END
    ...
    if (!l.isEmpty() || schema.isMandatory(slotName)) {
      ...
      try {
        for (int i = 0; i < l.size(); i++) {
          absAggregateValue
              .add((AbsTerm) Ontology.externalizeSlotValue(l.get(i), this, referenceOnto));
        }
