...
/**
 * This ontology allows dealing with Java Serializable objects as if they were instances of
 * ontological elements. <br>
  ...
  private SerializableOntology() {
    ...
    try {
      ...
      PrimitiveSchema stringSchema =
          (PrimitiveSchema) BasicOntology.getInstance().getSchema(BasicOntology.STRING);
      add(stringSchema);
