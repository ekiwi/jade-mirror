...
/**
 * Allows to specify in the ontological schema the <code>mandatory</code> and <code>name</code>
 * attributes of the slot.<br>
...
public @interface Slot {
  ...
  /**
   * Tell the BeanOntologyBuilder to treat this slot as a Serializable object. This is useful when
   * the type of a slot is not a valid java bean.
   */
  // NOTE that at runtime the slot value class must NOT have an associated schema.
  // If this is the case in facts, the slot value will be encoded according to
  // that
  // schema and, at decoding time there will be an incompatibility between the
  // slot
