...
/**
 * Allows to specify the ontological name of the <code>Concept</code> or <code>Predicate</code>, to
 * be used in place of the default (the rightmost part of the fully qualified class name).<br>
