...
/**
 * Allows to specify in the ontological schema the <code>cardMin</code> (minimum cardinality),
 * <code>cardMax</code> (maximum cardinality) and <code>type</code> (class of the contained
 * elements) attributes of the aggregate slot.<br>
