 ...
 * <p>
 * Yes, this is platform-specific code, and yes, it may rely on classes on certain platforms that
 ...
 * via a shell command.
 * <p>
 * This code is Copyright 1999 by Eric Albert (ejalbert@cs.stanford.edu) and may be redistributed or
 * modified in any form without restrictions as long as the portion of this comment from this
 * paragraph through the end of the comment is not removed. The author requests that he be notified
 * of any application, applet, or other binary that makes use of this code, but that's more out of
 * curiosity than anything and is not required. This software includes no warranty.
 * <p>
 * Credits: <br>
 * Steven Spencer, JavaWorld magazine
 * (<a href="http://www.javaworld.com/javaworld/javatips/jw-javatip66.html">Java Tip 66</a>) <br>
 * Ron B. Yeh, ZeroG <br>
...
public class BrowserLauncher {
   ...
   *         standard web browser; instead, it's the application that gets called to open the
   *         default web browser. In some cases, this will be a non-String object that provides the
    ...
    switch (jvm) {
      case MRJ_2_0:
        try {
          ...
          Object appleEvent = appleEventConstructor.newInstance(new Object[] {gurlType, gurlType,
              aeTarget, kAutoGenerateReturnID, kAnyTransactionID});
    ...
    switch (jvm) {
      ...
      case OTHER:
        ...
        Process process = Runtime.getRuntime().exec(
            (String) browser + NETSCAPE_OPEN_PARAMETER_START + url + NETSCAPE_OPEN_PARAMETER_END);
        try {
