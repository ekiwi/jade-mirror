...
/**
 * The <code>TimeChooser</code> class can be used to let the user define a certain point in time by
 * means of a dialog window.
 * <p>
 * <p>
 * 
...
public class TimeChooser implements ActionListener {
  ...
  public int showEditTimeDlg(JFrame parent) {
    ...
    /*
     * // THIS PART IS RELATED TO THE EDITING OF RELATIVE TIMES (NOT YET IMPLEMENTED) JPanel
     * modePanel = new JPanel(); absButton = new JToggleButton("Absolute"); relButton = new
    ...
    } else // Locate the dialog relatively to the screen
    {
      ...
      // #DOTNET_EXCLUDE_END
      /*
       * #DOTNET_INCLUDE_BEGIN int centerX = (int)screenSize.width / 2; int centerY =
       * (int)screenSize.height / 2; #DOTNET_INCLUDE_END
       */
