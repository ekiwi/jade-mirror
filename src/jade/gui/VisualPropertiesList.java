...
/**
 * This class extends the VisualStringList in order to show a list of user defined property. To show
 * these items correctly, have been overridden the methods:
 * 
 * <code>editElement</code> to show the UserPropertyGui when required. <code>removeElements</code>
 * since the superclass only maintain the key values is necessary to update properties.
 * 
...
public class VisualPropertiesList extends VisualStringList {
  ...
  /**
   * This method must be used to retry the actual properties. The method getContent of the super
   * class only returns the keys.
   */
