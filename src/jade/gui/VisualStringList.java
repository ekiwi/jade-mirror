...
/**
 * This class extends JPanel in order to provide a panel to show a list of string. Clicking the
 * right button of the mouse a popUp menu with the allowed operations is showed. The method
 * <code>setEnabled</code> permits to set the operation allowed. If enabled, three are the operation
 * allowed: Add new item, Edit an existing item, Remove a selected item; otherwise only the view
 * operation is allowed. Double clicking on a selected item permits the view/edit on it
 * 
 * Example of using this class:
 * 
 * JDialog d = new JDialog(); ... ArrayList a = new ArrayList(); a.add("element"); ....
 * VisualStringList listGui = new VisualStringList(a.iterator); list.setEnabled(true); // to sets
 * the popUpMenu to show the three choices Add Edit Remove list.setDimension(new Dimension(..,..));
 * d.getContentPane.().add(listGui);
 * 
 * If the user needs to show more complex items, can extend this class and override the needed
 * methods.
 * 
...
public class VisualStringList extends JPanel {
  ...
  /**
   * Constructor of a panel showing a list of strings. By default the panel is editable and all the
   * three operations (Add - Edit - Remove) are allowed.
   *
  ...
  /*
   * #DOTNET_INCLUDE_BEGIN public VisualStringList(jade.util.leap.Iterator content,Component
   * ownerGui) { owner = ownerGui; listModel = new DefaultListModel();
   * 
  ...
  /**
   * This method returns the string that will be shown on the panel. Can be override by subclasses
   * for more complex elements.
   */
