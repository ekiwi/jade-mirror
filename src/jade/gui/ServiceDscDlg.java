...
public class ServiceDscDlg extends JDialog {
  ...
  ServiceDescription viewSD(ServiceDescription dsc, boolean ed, boolean checkMandatorySlots) {
    ...
    // #DOTNET_EXCLUDE_END
    /*
     * #DOTNET_INCLUDE_BEGIN jade.util.leap.Iterator temp = serviceDesc.getAllProperties();
     * #DOTNET_INCLUDE_END
     */
          ...
          if (editable) {
            ...
            if (checkSlots) {
              ...
              if (getSaveText(txtName) == null) {
                JOptionPane.showMessageDialog(null, "The name must not be empty !", "Error Message",
                    JOptionPane.ERROR_MESSAGE);
                return;
              }

              if (getSaveText(txtType) == null) {
                JOptionPane.showMessageDialog(null, "The type must not be empty !", "Error Message",
                    JOptionPane.ERROR_MESSAGE);
                return;
              }
            }
