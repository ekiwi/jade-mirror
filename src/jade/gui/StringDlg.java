...
public class StringDlg extends JDialog {
  ...
  // CONSTRUCTORS
  /*
   * StringDlg(Frame parent, String hint) { super(parent); this.hint = new String(hint); this.out =
   * null; }
   * 
   * StringDlg(Dialog parent, String hint) { super(parent); this.hint = new String(hint); this.out =
   * null; }
   */
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (param.equals("OK")) {
          ...
          if (insertedValue.length() == 0) {
            JOptionPane.showMessageDialog(null, "Must have non-empty fields !", "Error Message",
