...
public class UserPropertyGui extends JDialog {
  ...
  /**
   * To show a given property. The boolean parameter permits to edit the fields or not. If editable
   * the method returns a property or null (if the Cancel button is pressed). If not editable
   * returns null.
   */
        ...
        if (param.equals("OK")) {
          if (editable) {
            ...
            if (name.length() > 0 && value.length() > 0)
              ...
              JOptionPane.showMessageDialog(thisGui, "Must have non-empty fields !",
