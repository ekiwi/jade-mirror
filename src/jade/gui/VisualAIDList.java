...
/**
 * This class extends the VisualStringList in order to show a list of AID (Agent-Identifer). To show
 * these items correctly, have been overridden the methods: <code>getElementName</code> to return
 * the name of the agent (shown in the list). <code>editElement</code> to show the ADIGui when
 * required.
 *
...
public class VisualAIDList extends VisualStringList {
   ...
   * @param isEditable A boolean flag telling whether the user is allowed to modify che chosen agent
   *        identifier or not.
   */
