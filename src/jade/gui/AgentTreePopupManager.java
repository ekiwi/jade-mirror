...
/**
 * This is a mouse listener attached to an AgentTree and is in charge of displaying the proper popup
 * menu when the user right-click on an item in the AgentTree.
 * 
...
class AgentTreePopupManager extends MouseAdapter {
   ...
   * AgentTree.Node current;
   * 
   * for (int i = 0; i < paths.length; i++) { current = (AgentTree.Node)
   * paths[i].getLastPathComponent(); if (!typeNode.equals(current.getType()))
