...
/**
 * This class implements the gui to manipulate a <code>DFAgentDescription</code>.
 * 
...
public class DFAgentDscDlg extends JDialog implements ActionListener {
  ...
  /*
   * #DOTNET_INCLUDE_BEGIN private Component myComponent; private Component getOwner() {return
   * myComponent;} #DOTNET_INCLUDE_END
   */
   ...
   * @param checkMandatorySlots true to verify that a value is specified for all the mandatory
   *        fields, false otherwise.
   * @return a DFAgentDescription if the OK button is pressed, false if the Cancel button is
   *         pressed.
   */
  public DFAgentDescription ShowDFDGui(DFAgentDescription dfd, boolean ed,
    ...
    /*
     * lease-time panel The duration or time at which the lease time for this registration will
     * expire. The default value of lease time is assumed to be unlimeted
     */
    ...
    bOK.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        if (param.equals("OK")) { // the user pressed the OK button
          if (editable) { // if it is editable then I have to collect all data in the GUI and create
                          // a
