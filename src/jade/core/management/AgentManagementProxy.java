...
/**
 * 
 * The remote proxy for the JADE kernel-level service managing the basic agent life cycle: creation,
...
public class AgentManagementProxy extends SliceProxy implements AgentManagementSlice {
  ...
  public void createAgent(AID agentID, String className, Object arguments[], JADEPrincipal owner,
  ...
  public void bornAgent(AID name, ContainerID cid, Command sourceCmd)
