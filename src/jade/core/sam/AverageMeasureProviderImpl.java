...
/**
 * A default ready-made implementation of the AverageMeasureProvider interface that offers methods
 * to add measure samples and automatically computes an <code>AverageMeasure</code> when the
