...
public class SAMService extends BaseService {
    ...
    try {
      ...
      for (int i = 0; i < handlerClasses.size(); ++i) {
        ...
        myLogger.log(Logger.CONFIG,
            "SAMInfoHandler of class = " + className + " successfully initialized");
      }
  ...
  private class SAMHelperImpl implements SAMHelper {
    ...
    public synchronized void addEntityMeasureProvider(String entityName,
        final MeasureProvider provider) {
    ...
    public synchronized void addCounterValueProvider(String counterName,
