...
public interface BackEnd {
  ...
  /**
   * Notify the BackEnd container that an agent has died. Note that this does not throw
   * NotFoundException as, if the BackEnd does not contain an AgentImage for the deadAgent it just
   * ignores the call.
   * 
   ...
   * @return the result of the invoked method or <code>null</code> if the method returns
   *         <code>void</code>
   */
  Object serviceInvokation(String actor, String serviceName, String methodName,
