...
/*
 * #DOTNET_INCLUDE_BEGIN import System.Net.*; import System.Net.Sockets.*; #DOTNET_INCLUDE_END
 */

/**
 * The <code>UDPMonitorClient</code> sends UDP ping messages in a specified interval to the main
 * container.
 *
...
class UDPMonitorClient {
  ...
  /*
   * #DOTNET_INCLUDE_BEGIN private UdpClient channel; private IPEndPoint receivePoint;
   * #DOTNET_INCLUDE_END
   */
  ...
  private class Sender implements Runnable {
    ...
    public void run() {
      ...
      while (running) {
        ...
        try {
          try {
            ...
            logger.log(Logger.WARNING, "Error sending UDP ping message to " + serverHost + ":"
                + serverPort + " for node " + node.getName());
          }
        ...
        // #DOTNET_EXCLUDE_END
        /*
         * #DOTNET_INCLUDE_BEGIN try { channel.Send(ping.getUByte(), ping.capacity(), serverHost,
         * serverPort); Thread.sleep(pingDelay - 5); } catch (Exception e) {
         * logger.log(Logger.WARNING,"Error sending UDP ping message to "+serverHost+":"
         * +serverPort+" for node " + node.getName()); } #DOTNET_INCLUDE_END
         */
      }
      ...
      try {
        ...
        // #DOTNET_EXCLUDE_END
        /*
         * #DOTNET_INCLUDE_BEGIN channel.Close(); } catch (Exception e) { #DOTNET_INCLUDE_END
         */
