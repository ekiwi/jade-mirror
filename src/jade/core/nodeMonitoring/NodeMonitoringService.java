...
/**
 * Base service for services that implements ad hoc node monitoring mechanisms such as the
...
public abstract class NodeMonitoringService extends BaseService {
  ...
  /**
   * Vertical command issued on the Main Container when a peripheral node returns reachable after
   * being unreachable for a while
   */
  public static final String NODE_REACHABLE = "Node-Unreachable";

  private static final String[] OWNED_COMMANDS = new String[] {NODE_UNREACHABLE, NODE_REACHABLE};
