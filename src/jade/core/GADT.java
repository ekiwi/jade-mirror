...
/**
 * The table holding information about all agents known to the platform (both agents living in the
 * platform and remote agents registered with the platform AMS).
 * 
