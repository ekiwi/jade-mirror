...
/**
 * 
 * The remote proxy for the JADE kernel-level service managing the mobility-related agent life
...
public class AgentMobilityProxy extends SliceProxy implements AgentMobilitySlice {
  ...
  public void createAgent(AID agentID, byte[] serializedInstance, String classSiteName,
      boolean isCloned, boolean startIt) throws IMTPException, ServiceException, NotFoundException,
      NameClashException, JADESecurityException {
    try {
  ...
  public byte[] fetchClassFile(String className, String agentName)
  ...
  public void copyAgent(AID agentID, Location where, String newName)
  ...
  public boolean transferIdentity(AID agentID, Location src, Location dest)
      throws IMTPException, NotFoundException {
    try {
  ...
  public void handleTransferResult(AID agentID, boolean result, List messages)
      throws IMTPException, NotFoundException {
    try {
      GenericCommand cmd =
          new GenericCommand(H_HANDLETRANSFERRESULT, AgentMobilitySlice.NAME, null);
      cmd.addParam(agentID);
  ...
  public void clonedAgent(AID agentID, ContainerID cid, Credentials creds)
  ...
  // #J2ME_EXCLUDE_BEGIN
  public void cloneCodeLocatorEntry(AID oldAgentID, AID newAgentID)
      throws IMTPException, NotFoundException {
    try {
      GenericCommand cmd =
          new GenericCommand(H_CLONECODELOCATORENTRY, AgentMobilitySlice.NAME, null);
  ...
  public void removeCodeLocatorEntry(AID name) throws IMTPException, NotFoundException {
    try {
      GenericCommand cmd =
          new GenericCommand(H_REMOVECODELOCATORENTRY, AgentMobilitySlice.NAME, null);
      cmd.addParam(name);
