...
/**
 * ServiceHelper provided by the MessagingService to make additional messaging features available to
 * agents
 */
public interface MessagingHelper extends ServiceHelper {
  /**
   * The interface to be implemented by classes that need to be notified about aliases
   * creation/deletion
   */
  ...
  /**
   * Register a listener that will be notified about alias creation/deletion. This methods can only
   * be invoked in a Main Container. Invoking that method in a peripheral container results in a
   * ServiceException
   * 
  ...
  /**
   * De-register a listener previously registered to be notified about alias creation/deletion. This
   * methods can only be invoked in a Main Container. Invoking that method in a peripheral container
   * results in a ServiceException
   * 
