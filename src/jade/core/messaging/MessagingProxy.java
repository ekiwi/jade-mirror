...
/**
 * The remote proxy for the JADE kernel-level service managing the message passing subsystem
...
public class MessagingProxy extends SliceProxy implements MessagingSlice {
  ...
  public void dispatchLocally(AID senderID, GenericMessage msg, AID receiverID)
