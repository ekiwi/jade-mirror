...
/**
 * The remote proxy for the JADE kernel-level service managing a persistent message delivery
 * subsystem installed in the platform. A persistent message delivery is able to deliver an ACL
 * message across an agent lifecycle, as long as the agent ID stays the same.
 * 
 * @author Giovanni Rimassa - FRAMeTech s.r.l.
 */
public class PersistentDeliveryProxy extends SliceProxy implements PersistentDeliverySlice {

  public boolean storeMessage(String storeName, GenericMessage msg, AID receiver)
