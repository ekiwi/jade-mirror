...
class InternalMessageQueue implements MessageQueue {
  ...
  // #MIDP_EXCLUDE_BEGIN
  // In MIDP we use Vector instead of jade.util.leap.LinkedList as the latter has
  // been implemented in terms of the first
  private LinkedList list;
  // #MIDP_EXCLUDE_END
  /*
   * #MIDP_INCLUDE_BEGIN private Vector list; #MIDP_INCLUDE_END
   */
  ...
  public InternalMessageQueue(int size, Agent a) {
    ...
    // #MIDP_EXCLUDE_END
    /*
     * #MIDP_INCLUDE_BEGIN list = new Vector(); #MIDP_INCLUDE_END
     */
  }
  ...
  public void addFirst(ACLMessage msg) {
    ...
    // #MIDP_EXCLUDE_END
    /*
     * #MIDP_INCLUDE_BEGIN list.setElementAt(msg,0); } else list.insertElementAt(msg,0);
     * #MIDP_INCLUDE_END
     */
  }
  ...
  public void addLast(ACLMessage msg) {
    ...
    // #MIDP_EXCLUDE_END
    /*
     * #MIDP_INCLUDE_BEGIN list.removeElementAt(0); } list.addElement(msg); #MIDP_INCLUDE_END
     */
  }
  ...
  public ACLMessage receive(MessageTemplate pattern) {
    ...
    for (Iterator messages = iterator(); messages.hasNext(); cnt++) {
      ...
      if (pattern == null || pattern.match(msg)) {
        ...
        // #MIDP_EXCLUDE_END
        /*
         * #MIDP_INCLUDE_BEGIN list.removeElementAt(cnt); #MIDP_INCLUDE_END
         */
        result = msg;
        break;
      }
  ...
  private Iterator iterator() {
    ...
    // #MIDP_EXCLUDE_END
    /*
     * #MIDP_INCLUDE_BEGIN return new EnumIterator(list.elements()); #MIDP_INCLUDE_END
     */
  }
