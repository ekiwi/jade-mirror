...
/**
 * Composite behaviour with concurrent children scheduling. It is a <code>CompositeBehaviour</code>
 * that executes its children behaviours concurrently, and it terminates when a particular condition
 * on its sub-behaviours is met i.e. when all children are done, <em>N</em> children are done or any
 * child is done.
 * 
...
public class ParallelBehaviour extends CompositeBehaviour {
  ...
  /**
   * Predefined constant to be used in the constructor to create a <code>ParallelBehaviour</code>
  ...
  /**
   * Construct a <code>ParallelBehaviour</code> without setting the owner agent, and using the
   * default termination condition (i.e. the parallel behaviour terminates as soon as all its
   ...
   *        <ol>
   *        <li><code>WHEN_ALL</code> to terminate this <code>ParallelBehaviour</code> when all its
   *        children are done.</li>
   *        <li><code>WHEN_ANY</code> to terminate this <code>ParallelBehaviour</code> when any of
   *        its child is done.</li>
   *        <li>a positive <code>int</code> value n to terminate this <code>ParallelBehaviour</code>
   *        when n of its children are done.</li>
   *        </ol>
   */
  ...
  /**
   * Return a Collection view of the children of this <code>ParallelBehaviour</code>
   * 
  ...
  /**
   * Return a Collection view of the children of this <code>ParallelBehaviour</code> that have
   * already completed.
   */
  ...
  /**
   * Resets this behaviour. This methods puts a <code>ParallelBehaviour</code> back in initial
   * state, besides calling <code>reset()</code> on each child behaviour recursively.
   */
  public void reset() {
  ...
  /**
   * Handle block/restart notifications. A <code>ParallelBehaviour</code> object is blocked
   * <em>only</em> when all its children behaviours are blocked and becomes ready to run as soon as
   * any of its children is runnable. This method takes care of the various possibilities.
   * 
