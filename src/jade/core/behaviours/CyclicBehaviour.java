...
/**
 * Atomic behaviour that must be executed forever. This abstract class can be extended by
 * application programmers to create behaviours that keep executing continuously (e.g. simple
 * reactive behaviours).
 * 
 * 
...
public abstract class CyclicBehaviour extends SimpleBehaviour {
  ...
  /**
   * This is the method that makes <code>CyclicBehaviour</code> cyclic, because it always returns
   * <code>false</code>.
   * 
