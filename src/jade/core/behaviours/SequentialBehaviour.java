...
/**
 * Composite behaviour with sequential children scheduling. It is a <code>CompositeBehaviour</code>
 * that executes its children behaviours in sequential order, and terminates when its last child has
 * ended.
 * 
 * 
...
public class SequentialBehaviour extends SerialBehaviour {
  ...
  /**
   * Sequential policy for children scheduling. This method schedules children behaviours one at a
   * time, in a FIFO fashion.
   * 
