...
/**
 * This behaviour allows modifying on the fly the way an existing behaviour object works The
 * following piece of code provides an example where we modify the <code>done()</code> method of an
 * existing behaviour object to print on the standard output a proper message when the behaviour is
 * completing.
 * 
 * <pr>
 * <hr>
