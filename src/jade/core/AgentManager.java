...
public interface AgentManager {
  ...
  /**
   * This callback interface is implemented by the AMS in order to be notified of significant
   * platform-level events (e.g. container added or removed, agents birth or death, mtp
  ...
  // JADE actions method
  /**
   * Create an agent on the given container. If the container-name is null then the agent is created
   ...
   **/
  void create(String agentName, String className, Object arguments[], ContainerID cid,
  ...
  void killContainer(ContainerID cid, JADEPrincipal requesterPrincipal,
      Credentials requesterCredentials)
      throws NotFoundException, UnreachableException, JADESecurityException;
  ...
  void uninstallMTP(String address, ContainerID cid)
      throws NotFoundException, UnreachableException, MTPException;
