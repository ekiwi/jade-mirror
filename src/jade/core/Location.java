...
/**
 * 
 * Abstract interface to represent JADE network locations. This interface can be used to access
 * information about the various places where a JADE mobile agent can migrate.
 * 
