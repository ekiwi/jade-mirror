...
public class ServiceManagerImpl implements ServiceManager, ServiceFinder {
  ...
  public synchronized void addAddress(String addr) throws IMTPException {
    ...
    if (invalidPlatformManager
        || !compareTransportAddresses(addr, myPlatformManager.getLocalAddress())) {
  ...
  private boolean compareAddresses(String addr1, String addr2) {
    ...
    // #MIDP_EXCLUDE_END
    /*
     * #MIDP_INCLUDE_BEGIN return CaseInsensitiveString.equalsIgnoreCase(addr1, addr2);
     * #MIDP_INCLUDE_END
     */
  }
  ...
  public void addNode(NodeDescriptor desc, ServiceDescriptor[] services)
  ...
  private void installServiceLocally(ServiceDescriptor svcDsc)
      throws IMTPException, ServiceException {
  ...
  /**
   * This method implements the platform reattachement procedure that is activated after a fault and
   * a successive recover of the Main Container.
   * 
  ...
  private synchronized void reattach(String pmAddr) {
    ...
    if (invalidPlatformManager
        || compareTransportAddresses(pmAddr, myPlatformManager.getLocalAddress())) {
  ...
  /**
   * This method implements the main reconnection procedure that is activated when the main
   * container this container is connected to crashes and a backup main container becomes the
   * leader.
   * 
      ...
      try {
        ...
        while (it.hasNext()) {
          ...
          try {
            ...
            myLogger.log(Logger.INFO, "Reconnecting to PlatformManager at address "
                + myPlatformManager.getLocalAddress());
