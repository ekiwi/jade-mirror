 ...
 * specifications. Copyright (C) 2000 CSELT S.p.A. GNU Lesser General Public License This library is
 * free software; you can redistribute it and/or modify it under the terms of the GNU Lesser General
 * Public License as published by the Free Software Foundation, version 2.1 of the License. This
 ...
 * Profile specifiers are used to describe several kinds of complex information when configuring
 * JADE (e.g. MTPs to install, agents to start up, kernel services to activate).
 *
 * The general string format for a specifier is
 * <p>
 * <code>name<b>:</b>className<b>(</b><i>separated arglist</i><b>)</b></code>
 * </p>
 * The separated argument list uses a separator character that can be configured when invoking
 * parsing-related utility methods.
 *
 * @author LEAP
 */
public class Specifier {
   ...
   * 
   * @return The name of the specifier, if one was set, or <code>null</code> otherwise.
   */
   ...
   * 
   * @return The class name of the specifier, if one was set, or <code>null</code> otherwise.
   */
   ...
   * 
   * @return An object array containing the argument list, if one was set, or <code>null</code>
   *         otherwise.
   */
  ...
  /**
   * This method is used by Boot, ProfileImpl, and RMA in order to have a String representation of
   * this Specifier according to the format <code>name:className(arg1 arg2 argn)</code>
   *
   * @return A string representation of this specifier, according to the format above.
   **/
    ...
    if (args != null) {
      ...
      for (int i = 0; i < args.length; i++) {
        ...
        if (i < args.length - 1) {
          ...
          // #ALL_EXCLUDE_END
          /*
           * #ALL_INCLUDE_BEGIN tmp.append(","); //#ALL_INCLUDE_END
           */
        }
      }
      tmp.append(")");
  ...
  /**
   * This static utility method can parse the string representation of a list of specifiers. The
   * general format of a specifier is used, with a comma as argument separator, i.e.:
   * <p>
   * <code>name<b>:</b>className<b>(</b><i>comma-separated arglist</i><b>)</b></code>
   * </p>
   * While comma is the separator character within a specifier arguments, the semicolon is used to
   * separate the different specifiers in the list.
   * 
   * @param specsLine The string containing the representation of the specifier list, according to
   *        the format above.
   ...
   * 
   * @param specString A string containing the representation of the specifier, according to the
   *        format above.
  ...
  public static Specifier parseSpecifier(String specString, char argsDelimiter) throws Exception {
    ...
    if (index2 < 0) {
      ...
      if (!specString.endsWith(")")) {
        throw new Exception(
            "Incorrect specifier \"" + specString + "\". Missing final parenthesis");
      }
  ...
  private static String[] parseArguments(String args, char argsDelimiter) {
    ...
    for (Enumeration e = argList.elements(); e.hasMoreElements(); arguments[i++] =
