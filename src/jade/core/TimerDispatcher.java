...
/**
 * This class implements the JADE internal timing system. It should not be used by application
 * developers.
 * 
...
public class TimerDispatcher implements Runnable {
  ...
  private boolean addTimer(Timer t) {
    ...
    // #J2ME_EXCLUDE_END
    /*
     * #J2ME_INCLUDE_BEGIN if (!timers.contains(t)) { int size = timers.size(); for (int i = 0; i <
     * size; i++) { Timer t1 = (Timer) timers.elementAt(i); if (t.expirationTime() <
     * t1.expirationTime()) { timers.insertElementAt(t, i); return true; } } timers.addElement(t);
     * return true; } return false; #J2ME_INCLUDE_END
     */
  }
