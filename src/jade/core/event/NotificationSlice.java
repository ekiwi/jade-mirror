...
/**
 * The horizontal interface for the JADE kernel-level service managing the event notification
...
public interface NotificationSlice extends Service.Slice {
  ...
  /**
   * This command name represents the action of deactivating a previously started instance of the
   * Sniffer agent.
   */
