...
public interface MessageQueue {
  ...
  /**
   * Return the maximum size of this queue. This queue may remove old messages to prevent exeding
   * the maximum size.
   */
  int getMaxSize();

  /**
   * Set the maximum size of this queue. This queue may remove old messages to prevent exeding the
   * maximum size.
   */
