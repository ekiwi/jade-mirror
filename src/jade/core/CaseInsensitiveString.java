...
/**
 * A name string, with case insensitive comparison and equality operations. This class holds a
 * <code>String</code> inside, preserving the case; however, all the equality and comparision
 * operations are performed in a case insensitive fashion.
 * 
...
public class CaseInsensitiveString implements Serializable {
  ...
  /**
   * Equality operation. This method compares a <code>CaseInsensitiveString</code> object with
   * another or with a Java <code>String</code>. The comparison is case insensitive.
   * 
   * @param o The Java object to compare this <code>CaseInsensitiveString</code> to.
   * @return <code>true</code> if the strings contained within the two objects are equal, apart from
   *         case.
   */
   ...
   * <code>CaseInsensitiveString</code> objects differing only in case have the same hash code.
   * 
  ...
  /**
   * Static method for case insensitive string comparasion. For comparasion used the regionMatches
   * approach which doesn't allocate any additional memory.
   * 
