...
public interface PlatformManager {
   ...
   */
  String addNode(NodeDescriptor dsc, Vector nodeServices, boolean propagated)
  ...
  void addSlice(ServiceDescriptor service, NodeDescriptor dsc, boolean propagated)
      throws IMTPException, ServiceException;

  void removeSlice(String serviceKey, String sliceKey, boolean propagated)
      throws IMTPException, ServiceException;
