...
/**
 * This interface represents a node of a JADE platform (i.e. a component that can host a slice of a
 * platform-level service). Concrete nodes for a platform are created by the concrete IMTP manager.
 * 
...
public interface Node extends Serializable {
  ...
  /**
   * Accepts a command. If this node is a proxy, the <code>accept()</code> method is a remote
   * method, forwarding the command to the remote location it represents.
   * 
