...
public interface IMTPManager {
   ...
   * 
   * @return A <code>Node</code> object, representing the local node of this platform.
   * @throws IMTPException If something goes wrong in the underlying network transport.
   */
   ...
   * 
   * @param mgr The <code>ServiceManager</code> implementation that is to be made available across
   *        the network.
   * @throws IMTPException If something goes wrong in the underlying network transport.
   */
   ...
   * 
   * @param itfs The array of all the interfaces that have to be implemented by the returned proxy.
   *        The first element of the array must be an interface derived from
   *        <code>Service.Slice</code>.
   * @return A proxy object that can be safely casted to any of the interfaces in the
   *         <code>itfs</code> array.
   * @throws IMTPException If something goes wrong in the underlying network transport.
   * 
  ...
  /**
   * Return the the List of TransportAddress where this IMTP is waiting for intra-platform remote
   * calls.
   */
