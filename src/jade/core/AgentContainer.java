...
/**
 * This interface represents the local container as it is seen by JADE kernel level services
 * installed in the underlying Node
 * 
...
public interface AgentContainer {
  ...
  void initAgent(AID agentID, Agent instance, JADEPrincipal ownerPrincipal,
