...
/**
 * The <code>Command</code> interface has to be implemented by all JADE kernel-level commands, used
 * by the various platform services.
 * 
...
public interface Command {
   ...
   * 
   * @return The value that is to be returned back to the issuer of this <code>Command</code>
   *         object.
   */
