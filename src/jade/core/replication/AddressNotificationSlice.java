...
/**
 * The horizontal interface for the JADE kernel-level service distributing the <i>Service
 * Manager</i> address list throughout the platform.
 * 
...
public interface AddressNotificationSlice extends Service.Slice {
  ...
  /**
   * This command name represents the notification of the addition of a new address to the
   * <i>Service Manager</i> of the platform.
   */
  // static final String SM_ADDRESS_ADDED = "SM-Address-Added";

  /**
   * This command name represents the notification of the removal of an address from the <i>Service
   * Manager</i> of the platform.
   */
