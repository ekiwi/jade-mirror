...
/**
 * The remote proxy for the JADE kernel-level service distributing the <i>Service Manager</i>
 * address list throughout the platform.
 * 
...
public class AddressNotificationProxy extends SliceProxy implements AddressNotificationSlice {
  ...
  /*
   * public void removeServiceManagerAddress(String addr) throws IMTPException { try {
