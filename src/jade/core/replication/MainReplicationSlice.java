...
/**
 * The horizontal interface for the JADE kernel-level service managing the main-container
 * replication subsystem installed in the platform.
 * 
...
public interface MainReplicationSlice extends Service.Slice {
  ...
  void addReplica(String sliceName, String smAddr, int sliceIndex, NodeDescriptor dsc,
