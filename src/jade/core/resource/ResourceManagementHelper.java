...
/**
 * The ResourceManagementHelper provides methods that allows to access resources available on the
 * main or other containers.
 */
public interface ResourceManagementHelper extends ServiceHelper {
   ...
   * @return resource as byte array
   */
  byte[] getResource(String name, int fetchMode, String containerName)
