...
/**
 * An implementation of this interface is used by the FaultRecoveryService to save the information
 * required to recover a platform after a fault of the Main Container.
 * 
...
public interface PersistentStorage {
  ...
  /*
   * void storeAgent(String name, byte[] aa) throws Exception; void removeAgent(String name) throws
   * Exception; Map getAllAgents() throws Exception;
   */
}
