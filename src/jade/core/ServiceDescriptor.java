...
/**
 * 
 * The <code>ServiceDescriptor</code> class serves as a meta-level description of a kernel-level
 * service. Instances of this class contain a <code>Service</code> object, along with its name and
...
public class ServiceDescriptor implements Serializable {
  ...
  /**
   * Builds a new service descriptor, describing the given service with the given name and
   * properties.
   * 
   ...
   * 
   * @return The name of the described service, or <code>null</code> if no name was set.
   */
   ...
   * 
   * @param svc The <code>Service</code> object that is to be described by this service descriptor.
   */
   ...
   * 
   * @return The <code>Service</code> object described by this service descriptor, or
   *         <code>null</code> if no service was set.
   */
    ...
    if (serviceClass != null) {
      try {
        ...
        throw new java.io.IOException(
            "Can't create service " + serviceClass + ". " + t.getMessage());
      }
    }
  }
  // #MIDP_EXCLUDE_END
