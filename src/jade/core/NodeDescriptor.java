...
/**
 * 
 * The <code>NodeDescriptor</code> class serves as a meta-level description of a kernel-level
 * service. Instances of this class contain a <code>Node</code> object, along with its name and
 * properties, and are used in service management operations, as well as in agent-level
 * introspection of platform-level entities.
 * 
...
public class NodeDescriptor implements Serializable {
   ...
   * 
   * @return The name of the described node, or <code>null</code> if no name was set.
   */
   ...
   * 
   * @param node The <code>Node</code> object that is to be described by this node descriptor.
   */
   ...
   * 
   * @return The <code>Node</code> object described by this node descriptor, or <code>null</code> if
   *         no node was set.
   */
  public Node getNode() {
    return myNode;
   ...
   * 
   * @return The <code>ContainerID</code> of the hosted container, or <code>null</code> if no such
   *         container was set.
   */
   ...
   * 
   * @return The principal of the owner of this node, or <code>null</code> if no principal was set.
   */
   ...
   * 
   * @return The credentials of the owner of this node, or <code>null</code> if no credentials were
   *         set.
   */
