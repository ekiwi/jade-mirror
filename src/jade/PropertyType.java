...
/**
 * 
 * This class defines the necessary information for the configuration properties of JADE. For every
 * property some information are necessary to show the correctly: the name, the type (integer,
 * boolean or string), the default Value, , the string to show as tooltip in the gui at start up and
 * a boolean to indicate if the property is mandatory or not.
 * 
...
public class PropertyType {
   ...
   * @param mandatory true if the property is mandatory, false otherwise.
   */
  public PropertyType(String name, String type, String[] en, String def, String desc,
      boolean mand) {
    this.name = name;
    this.type = type;
    this.fixedEnum = en;
