...
public interface TwoPhConstants {
  ...
  /*
   * update1 public static final int ALL_PROPOSE = 1; public static final int PH0_TIMEOUT_EXPIRED =
   * MsgReceiver.TIMEOUT_EXPIRED; public static final int SOME_FAILURE = 2;
   */
