...
public class TwoPhResponder extends Responder {
   ...
   * @return the ACLMessage to be sent as a response (i.e. one of <code>PROPOSE, FAILURE</code>.
   *         <b>Remind</b> to use the method <code>createReply</code> of the class ACLMessage in
   *         order to create a valid reply message
  ...
  /**
   * This method is called after the <code>QUERY-IF</code> has been received. This default
   * implementation return null which has the effect of sending no result notification. Programmers
   ...
   *         <code>CONFIRM, INFORM, DISCONFIRM</code>. <b>Remind</b> to use the method createReply
   *         of the class ACLMessage in order to create a valid reply message
   * @see jade.lang.acl.ACLMessage#createReply()
   **/
  ...
  /**
   * This method is called after the <code>REJECT-PROPOSAL</code> has been received. This default
   * implementation do nothing. Programmers should override the method in case they need to react to
   * this event.
   * 
   * @param reject the received message
   * @return the ACLMessage to be sent as a result notification (i.e. an <code>INFORM</code>.
   *         <b>Remind</b> to use the method createReply of the class ACLMessage in order to create
   *         a valid reply message
   * @see jade.lang.acl.ACLMessage#createReply()
   **/
  ...
  /**
   * This method is called after the <code>ACCEPT-PROPOSAL</code> has been received. This default
   * implementation return null which has the effect of sending no result notification. Programmers
   * should override the method in case they need to react to this event.
   * 
  ...
  /**
   * This method allows to register a user defined <code>Behaviour</code> in the PREPARE_PROPOSE
  ...
  /**
   * This method allows to register a user defined <code>Behaviour</code> in the HANDLE_QUERY_IF
   * state. This behaviour would override the homonymous method. This method also set the data store
   * of the registered <code>Behaviour</code> to the DataStore of this current behaviour. It is
   * responsibility of the registered behaviour to put the response to be sent into the datastore at
  ...
  /**
   * This method allows to register a user defined <code>Behaviour</code> in the HANDLE_REJECT
   * state. This behaviour would override the homonymous method. This method also set the data store
   * of the registered <code>Behaviour</code> to the DataStore of this current behaviour. It is
   * responsibility of the registered behaviour to put the response to be sent into the datastore at
   * the <code>REPLY_KEY</code> key.
  ...
  /**
   * This method allows to register a user defined <code>Behaviour</code> in the HANDLE_ACCEPTANCE
   * state. This behaviour would override the homonymous method. This method also set the data store
   * of the registered <code>Behaviour</code> to the DataStore of this current behaviour. It is
   * responsibility of the registered behaviour to put the response to be sent into the datastore at
   * the <code>REPLY_KEY</code> key.
  ...
  protected boolean checkInSequence(ACLMessage received) {
    ...
    switch (phase) {
      ...
      case 1:
        return (perf == ACLMessage.CFP || perf == ACLMessage.QUERY_IF
