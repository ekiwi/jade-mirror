...
/**
 * This behaviour is used as a state of a FSMbehavior in order to reset some of the FSM's states or
 * the whole FSM
 *
...
public class StateResetter extends OneShotBehaviour {
   ...
   * Constructor.
   * 
   * @param states Represent the names of FSM's to reset. If null the parent Behaviour is resetted
   * 
   */
