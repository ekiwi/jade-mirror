...
/**
 * This behaviour sends a reply to a given message adjusting all protocol fields and receivers. It
 * reads in DataStore the message and the reply at the keys passed in the Constructor.
 * 
