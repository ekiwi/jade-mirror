 ...
 * compliance with the FIPA specifications. Copyright (C) 2002 TILAB
 * 
...
public class ThreadGroupHttpAuthenticator extends Authenticator {
  ...
  /**
   * Set the list of host excluded from proxy. Use <code>|</code> to separate hosts. Permitted
   * <code>*</code> as wildcards.
   * 
  ...
  private synchronized void setCredential(String threadGroupName, String username,
      String password) {
    ...
    if (username != null) {
      PasswordAuthentication passwordAuthentication =
          new PasswordAuthentication(username, password != null ? password.toCharArray() : null);
