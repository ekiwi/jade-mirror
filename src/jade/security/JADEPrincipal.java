...
/**
 * The <code>JADEPrincipal</code> interface represents all principals acting on the platform. They
 * will be held responsible for their own agents and containers.
 * 
...
// #ALL_EXCLUDE_END
{
  ...
  /**
   * Checks the hierarchical relationship between two principals, i.e. tells if this principal
   * belongs to group <code>p</code>. If this holds, all permissions granted to <code>p</code> will
   * be automatically granted to this principal, too.
   * 
