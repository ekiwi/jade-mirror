...
/**
 * This class handles JADE start-up and shut-down when running JADE as an Applet. The
 * split-container mode is used. <br>
...
public class AppletBoot extends Applet implements Runnable {
  ...
  public String[][] getParameterInfo() {
    String[][] info = {
        {MicroRuntime.AGENTS_KEY, "semicolon-separated agent specifiers",
            "The agents to be started"},
        {MicroRuntime.PORT_KEY, "integer",
            "The port of the JADE container on the applet codbase host"},
        {MicroRuntime.CONN_MGR_CLASS_KEY, "String",
            "The class for BackEnd-to-FrontEnd communication"}};
    return info;
  }
