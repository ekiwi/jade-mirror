 ...
 * the License.
 * 
 * This library is distributed in the hope that it will be usefubut WITHOUT ANY WARRANTY; without
...
/**
 * This class is a Proxy class, allowing access to a JADE agent container. Invoking methods on
 * instances of this class, it is possible to request services from <it>in-process</it> agent
 * containers. This class must not be instantiated by applications. Instead, use the
 * <code>createContainer()</code> method in class <code>Runtime</code>. <br>
...
public class ContainerController {
  ...
  /**
   * This constructor requires a concrete implementation of a JADE agent container, which cannot be
   * instantiated by applications, so it cannot be meaningfully called from application code. The
   * proper way to create an agent container from an application is to call the
   ...
   * @param isGuid A flag indicating whether <code>name</code> represents the local-name
   *        (<code>AID.ISLOCALNAME</code>) or the GUID (<code>AID.ISGUID</code>) of the desired
   *        agent.
   * @throws ControllerException If any problems occur obtaining this proxy or if no such agent
   *         exists in the local container.
   */
  ...
  /**
   * Retrieve a controller for the platform the container wrapped by this ContainerController
   * belongs to and acts as the Main Container.
   * 
   * @return a <code>PlatfromController</code> for the platform the container wrapped by this
   *         <code>ContainerController</code> belongs to.
   * @exception ControllerException If the container wrapped by this
   *            <code>ContainerController</code> is not valid or is not the platform Main Container.
   */
