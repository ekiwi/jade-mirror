...
/**
 * This class is a Proxy class, allowing access to a JADE agent. Invoking methods on instances of
 * this class, it is possible to trigger state transition of the agent life cycle. This class must
 * not be instantiated by applications. Instead, use the <code>createAgent()</code> method in class
...
class AgentControllerImpl implements AgentController {
  ...
  public <T> T getO2AInterface(Class<T> theInterface) throws StaleProxyException {
    ...
    try {
      ...
      return (T) java.lang.reflect.Proxy.newProxyInstance(classLoader, new Class[] {theInterface},
          new O2AProxy(o2aInterfaceImpl) {
  ...
  public State getState() throws StaleProxyException {
    ...
    switch (jadeState) {
      ...
      /*
       * case jade.core.Agent.AP_TRANSIT: ret = AgentState.AGENT_STATE_INTRANSIT; break;
       */
      default:
