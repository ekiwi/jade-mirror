...
class PlatformControllerImpl implements PlatformController {
  ...
  /**
   * Kill the agent platform with all its agents. <br>
   * <b>NOTE</b> that this method must not be executed within an agent Thread. This in fact would
   * cause a deadlock condition. If an agent needs to invoke it it should spawn a dedicated Thread.
   * 
   * @throws ControllerException If any probelms other than illegal state occur.
   * @throws IllegalStateException If state is illegal for this activity.
   */
   ...
   * @throws IllegalStateException If state is illegal for this activity.
   * @throws ControllerException If any else goes wrong. All other exceptions are caught and
   *         rethrown as a ControllerException.
   */
   ...
   */
  public synchronized void addPlatformListener(PlatformController.Listener aListener)
      throws ControllerException {
   ...
   * @param aListener The listener to be notified.
   */
  public synchronized void removePlatformListener(PlatformController.Listener aListener)
      throws ControllerException {
  ...
  /**
   * Inner class AgentManagerListenerAdapter This utility class provides a dummy implementation of
  ...
  /**
   * Inner class ListenerWrapper This utility class wraps a jade.wrapper.PlatformController.Listener
