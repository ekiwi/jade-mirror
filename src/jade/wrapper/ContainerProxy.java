...
/**
 * This interface is used by an AgentController or ContainerController to request action to the
 * underlying implementation as if they where received from the main container. <br>
