...
/**
 * This class is maintained for backward compatibility only. It is not deprecated since, for
 * backward compatibility reasons, it is used internally by the framework. Use
 * <code>jade.wrapper.ContainerController</code> instead.
 * 
