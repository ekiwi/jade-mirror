...
/**
 * Provides a concrete implementation of the State interface for agents. <br>
...
public class AgentState extends StateBase {
   ...
   */
  static final String[] stateNames = {"Initiated", // 1
      "Active", // 2
      "Idle", // 3
      "Suspended", // 4
      "Waiting", // 5
   ...
   * create instances of this class should come from the {@link StateConstants StateConstants}
   * class.
   * <p>
