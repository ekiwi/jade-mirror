...
public class Toolkit {
  ...
  public static String substituteParameters(String expression, Properties parameters,
      String startDelim, String stopDelim) {
      ...
      if (paramStart == -1) {
        ...
        if (paramEnd == -1) {
          throw new IllegalArgumentException('"' + expression
              + "\" has no closing brace. Opening brace at position " + paramStart + '.');
        } else {
          ...
          if (replacement != null) {
            ...
            String recursiveReplacement =
                substituteParameters(replacement, parameters, startDelim, stopDelim);
