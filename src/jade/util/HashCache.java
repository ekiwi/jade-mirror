...
/**
 * This class is a cache with fixed dimension that can be set in the constructur. All element are
 * indexed with an hashcode.
 * 
...
public class HashCache implements Map {
  ...
  /**
   * Adds the specified element to this hashcache if it is not already present. If the cache is
   * already full,the oldest element is deleted.
   * 
  ...
  /**
   * Tests if the specified object is a key in this hashcache. present. the oldest element is
   * deleted.
   * 
   * @param o element to be added to this set.
   * @return true if the haschcache contains the object <CODE>o</CODE>, otherwise false
   * 
   */
  ...
  /**
   * Retrieves a cached element. The retrieved element is also marked as the last used one, so that
   * the cache replacement policy becomes LRU instead of FIFO.
   * 
   * @param o The
   */
