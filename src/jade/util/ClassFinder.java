...
/**
 * This utility class was based originally on Daniel Le Berre's <code>RTSI</code> class. This class
 * can be called in different modes, but the principal use is to determine what
...
public class ClassFinder {
   ...
   */
  public final Vector findSubclasses(String fqcn, ClassFinderListener aListener,
  ...
  /**
   * The result of the last search is cached in this object, along with the URL that corresponds to
   * each class returned. This method may be called to query the cache for the location at which the
   * given class was found. <code>null</code> will be returned if the given class was not found
  ...
  /**
   * Determine every URL location defined by the current classpath, and it's associated package
   * name.
   */
  ...
  private final void findSubclasses(URL location, String packageName, Class superClass,
      Set setOfClasses) {
