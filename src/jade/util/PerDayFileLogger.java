...
/**
 * This class is an OutputStream whose output is stored in in different files according to the day
 * it is produced. Existing files, if any, are not rewritten as output is appended at the end of the
 * file.
 * 
