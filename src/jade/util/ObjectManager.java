...
/**
 * Utility class to manage instances of classes with attached properties i.e. classes specified in
 * the form<br>
 * foo.Bar[key1=value1,key2=value2...] This class allows registering "Loaders" for given types of
 * objects (e.g. agents) and successively load such objects using them
 */
public class ObjectManager {
  ...
  /**
   * The interface to be implemented by classes that can be registered to load objects of a given
   * type
   */
  public static interface Loader {
    Object load(String className, Properties pp)
        throws ClassNotFoundException, IllegalAccessException, InstantiationException;
  }

  /**
   * Convert a class-name, possibly with attached properties, into a Properties object The actual
   * class-name will be available as the value of the <code>CLASS_NAME</code> property
   */
  ...
  /**
   * Register a <code>Loader</code> for a given type of object. Note that more than one
   * <code>Loader</code> can be associated to a given type of object.
   * 
   ...
   */
  public synchronized static Object load(String extendedClassName, String type)
      throws ClassNotFoundException, IllegalAccessException, InstantiationException {
