...
/**
 * The LEAP (environment-dependent) version of the &qote;java.util.HashMap&qote; class. This class
 * appears to be exactly the same in J2SE, PJAVA and MIDP. The internal implementation is different
 * in the three cases however.
 * 
...
public class HashMap implements Map, Serializable {
  ...
  /**
   * The following elements are required to ensure compatibility with the J2ME version of this class
   * in serialization/deserialization operations.
   */
  ...
  public Collection values() {
    if (values == null) {
      values = new Collection() {
        ...
        public Iterator iterator() {
          return new Iterator() {
            java.util.Iterator it = HashMap.this.realHiddenMap.values().iterator();
  ...
  /**
   * A customized writeObject() method is needed to ensure compatibility with the J2ME version of
  ...
  /**
   * A customized readObject() method is needed to ensure compatibility with the J2ME version of
   * this class in serialization/deserialization operations
   */
