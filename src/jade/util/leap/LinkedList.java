...
/**
 * The LEAP (environment-dependent) version of the &qote;java.util.ArrayList&qote; class. This class
...
public class LinkedList implements List, Serializable {
  ...
  /**
   * Appends the given element to the end of this list. (Identical in function to the <tt>add</tt>
