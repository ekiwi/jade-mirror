...
public interface InChannel {
   ...
   * 
   * @parameter p is the Profile from which the configuration parameters for this instance of JADE
   *            container can be retrieved
   * @return A <code>TransportAddress</code>, corresponding to the chosen default address.
   ...
   * 
   * @param ta A <code>TransportAddress</code> object, representing the transport address to listen
   *        to.
   * @parameter p is the Profile from which the configuration parameters for this instance of JADE
   *            container can be retrieved
   * @exception MTPException Thrown if some MTP initialization error occurs.
   ...
   * 
   * @param ta The <code>TransportAddress</code> object the handle to close is listening to.
