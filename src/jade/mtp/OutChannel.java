...
public interface OutChannel {
  ...
  /**
   * Delivers to the specified address an ACL message, encoded in some concrete message
   * representation, using the given envelope as a transmission header.
   * 
   * @param ta The transport address to deliver the message to. It must be a valid address for this
   *        MTP.
   * @param env The message envelope, containing various fields related to message recipients,
   *        encoding, and timestamping.
