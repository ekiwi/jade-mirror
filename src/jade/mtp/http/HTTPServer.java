      ...
      try {
        ...
        do {
          ...
          if (HTTPIO.OK.equals(responseMsg)) {
            ...
            /*
             * #DOTNET_INCLUDE_BEGIN //There are problems if PayloadEncoding is set to US-ASCII if
             * (env.getPayloadEncoding() == null) env.setPayloadEncoding(XMLCodec.CHARS_CODEC);
             * #DOTNET_INCLUDE_END
             */
