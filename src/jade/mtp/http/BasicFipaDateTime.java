/**
 * Java Agent Message Router - JAMR ( http://liawww.epfl.ch/~cion/jamr ) FIPA compliant Message
 * Transport Implementation
 *
 * Copyright (C) 2000, 2001, Laboratoire d'Intelligence Artificielle, Echole Polytechnique Federale
 * de Lausanne ( http://liawww.epfl.ch )
 *
 ...
 * (file lesser.txt); if not, try downloading it from http://www.gnu.org/copyleft/lesser.txt or
 ...
 * @version 0.72
 * @author Nicolas Lhuillier (Motorola Labs) Corrected bug with Java Calendar class
 * @version 1.0
 */
...
public class BasicFipaDateTime {
  ...
  public String toString() {
    ...
    str_date = str_date + paddedInt(2, cal.get(Calendar.MINUTE))
        + paddedInt(2, cal.get(Calendar.SECOND)) + paddedInt(3, cal.get(Calendar.MILLISECOND));
   ...
   * System.out.println("Initial date: 20030812Z171910154"); BasicFipaDateTime bfdt = new
   * BasicFipaDateTime("20030812Z171910154"); System.out.println(bfdt.toString());
   * System.out.println("Year:  "+bfdt.getYear()); System.out.println("Month: "+bfdt.getMonth());
   * System.out.println("Day:   "+bfdt.getDay()); System.out.println("Hour:  "+bfdt.getHour());
   ...
   * System.out.println(); System.out.println("Current date: "+new BasicFipaDateTime(new
   * Date()).toString()); }
   */
