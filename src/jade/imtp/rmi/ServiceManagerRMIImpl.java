...
class ServiceManagerRMIImpl extends UnicastRemoteObject implements ServiceManagerRMI {
  ...
  public ServiceManagerRMIImpl(PlatformManager pm, RMIIMTPManager mgr, int port)
  ...
  public String addNode(NodeDescriptor dsc, Vector nodeServices, boolean propagated)
      throws RemoteException, ServiceException, JADESecurityException {
    try {
  ...
  public void addReplica(String newAddr, boolean propagated)
    ...
    try {
      ...
      // Note that addReplica() may activate remote calls --> An IMTPException in this
