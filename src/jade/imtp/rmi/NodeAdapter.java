...
/**
 * This class wraps an RMI endpoint representing the local platform node. When this node is sent
 * over the network, the RMI stub is transferred, too.
 * 
...
class NodeAdapter extends BaseNode {
  ...
  public NodeAdapter(String name, boolean hasSM, int port, RMIIMTPManager mgr)
  ...
  public void platformManagerDead(String deadPmAddress, String notifyingPmAddr)
