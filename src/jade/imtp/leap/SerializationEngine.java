...
class SerializationEngine {
  ...
  final static byte[] serialize(Command cmd) throws LEAPSerializationException {
    ...
    try {
      ...
      // Logger.println("Serialized command. Type = "+cmd.getCode()+". Length = "+(bb
      // != null ? bb.length : 0));
      return bb;
  ...
  final static Command deserialize(byte[] data) throws LEAPSerializationException {
    try {
      ...
      // Logger.println("De-serialized command. Type = "+cmd.getCode()+". Length =
  ...
  /**
   * Writes an object whose class is not known from the context to a given DataOutputStream.
   * 
   ...
   */
  private final static void serializeObject(Object o, DataOutputStream dos)
    ...
    try {
      ...
      throw new LEAPSerializationException(
          "I/O Error Serializing object " + o + ". " + ioe.getMessage());
    }
  }

  /**
   * Reads an object whose class is not known from the context from a given DataInputStream.
   * 
   ...
   */
  private final static Object deserializeObject(DataInputStream dis, byte[] data)
      throws LEAPSerializationException {
    try {
      ...
      switch (id) {
        ...
        default:
          /*
           * System.out.println("Packet was:"); jade.imtp.leap.JICP.JICPPacket pkt =
           * jade.imtp.leap.JICP.BIFEDispatcher.lastResponseCazzo;
           ...
           * 
           * System.out.println("Data to deserialize is:"); for (int i = 0; i < data.length; ++i) {
           * System.out.print(data[i]+" "); if ((i % 16) == 0 && i != 0) { System.out.println(""); }
           * }
           */
  ...
  private final static void serializeStringArray(String[] ss, DataOutputStream dos)
  ...
  private final static String[] deserializeStringArray(DataInputStream dis)
      throws IOException, LEAPSerializationException {
