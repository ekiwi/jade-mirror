...
public class Command {
  ...
  /**
   * Allows reusing the same object to deal with another command. Generally used to build a response
   * to an incoming command.
   */
  void reset(int code) {
    commandCode = code;
    objectID = DUMMY_ID;
  ...
  /**
   * Add a deliverable parameter, i.e., an object implementing the <code>Deliverable</code>
   * interface or a <code>java.lang.String</code> or a <code>java.lang.StringBuffer</code> object to
   * the end of the argument list of this command object.
   * 
