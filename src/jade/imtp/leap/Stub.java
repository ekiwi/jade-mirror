...
class Stub implements jade.util.leap.Serializable {
  ...
  /**
   * Build a stub for a given already remotized object. Note that TAs are added separately as we
   * don't know at this stage whether this is a Stub to reach a remote object or a Stub for a local
   * object.
   */
  ...
  /**
   * Add a TransportAddress to the list of addresses of the remote object this is a stub of
   */
