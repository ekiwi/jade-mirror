 ...
 * 
 * This JICP peer uses secure connections with or without mutual authentication of the endpoints by
 * using digital certificates. It leverages SSL/TLS.
 *
...
public class JICPSPeer extends JICPPeer {
  ...
  private ServerSocket getServerSocketWithAuth(String host, int port, boolean changePortIfBusy)
      throws ICPException {
  ...
  private ServerSocket getServerSocketNoAuth(String host, int port, boolean changePortIfBusy)
      throws ICPException {
    // Create the SSLContext if necessary
    if (ctx == null) {
