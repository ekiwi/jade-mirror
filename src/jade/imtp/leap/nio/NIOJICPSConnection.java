...
/**
 * This class provides a nio based server connection for which ssl can be configured. A
 * {@link SSLEngine} is used for dealing with handshaking and encrypting/decrypting application
 * data. The superclass does the actual {@link #fillHeader(java.nio.ByteBuffer) reading} (also
 * {@link #fillPayload(java.nio.ByteBuffer)}), and {@link #writeToChannel(java.nio.ByteBuffer)
 * writing} from the SocketChannel and handles the application data.
 *
 * @see SSLContext
 * @author eduard
 */
