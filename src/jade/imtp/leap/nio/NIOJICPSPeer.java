...
/**
 * This class provides a {@link ConnectionFactory} that will construct {@link NIOJICPSConnection
 * NIOJICPSConnections}. Before the NIOJICPSConnections can be used
 * {@link NIOJICPSConnection#init(java.nio.channels.SelectionKey)} must be called.
 * 
 * @author eduard
 */
