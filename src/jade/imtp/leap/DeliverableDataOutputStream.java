...
/**
 * This class implements a data output stream serializing Deliverables, primitive types and J2SE
 * class types that are considered as primitive type to a given byte array according to the LEAP
...
class DeliverableDataOutputStream extends DataOutputStream {
  ...
  /**
   * Constructs a data output stream that is serializing Deliverables to a given byte array
  ...
  /**
   * Get the byte array that contains the frozen, serialized Deliverables written to this data
   * output stream.
   * 
   * @return the byte array containing the serialized Deliverables written to this data output
   *         stream
   */
  ...
  /**
   * Writes an object whose class is not known from the context to this data output stream.
   * 
   * @param o the object to be written.
   * @exception LEAPSerializationException if an error occurs during serialization or the object is
   *            an instance of a class that cannot be serialized.
   */
  public void writeObject(Object o) throws LEAPSerializationException {
    try {
      if (o != null) {
        ...
        /*
         * #MIDP_INCLUDE_BEGIN // In J2SE and PJAVA we use Java serialization to transport //
         * Throwable objects so that we keep the correct message. else if(o instanceof Throwable) {
         * // Throwable writeByte(Serializer.THROWABLE_ID); serializeThrowable((Throwable) o); }
         * #MIDP_INCLUDE_END
         */
        // #MIDP_EXCLUDE_BEGIN
   ...
   * @exception LEAPSerializationException if an error occurs during serialization
   */
  ...
  private void serializeNodeDescriptor(NodeDescriptor desc)
  ...
  private void serializeGenericMessage(GenericMessage gm)
      throws IOException, LEAPSerializationException {
  ...
  // #J2ME_EXCLUDE_BEGIN
  private void serializeMultipleGenericMessage(MultipleGenericMessage mgm)
      throws IOException, LEAPSerializationException {
  ...
  private void serializeContainerIDArray(ContainerID[] cida)
      throws IOException, LEAPSerializationException {
  ...
  /**
   */
  private void serializeServiceSliceProxy(Service.SliceProxy proxy)
  ...
  private void serializeStub(Stub stub) throws LEAPSerializationException {
    try {
      ...
      // Write the remote ID, uniquely identifying the remotized object this stub
      // points to
