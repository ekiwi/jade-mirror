...
/**
 * The <code>ServiceManagerStub</code> class is the remote proxy of JADE platform <i>Service
 * Manager</i> and <i>Service Finder</i> components, running over LEAP transport layer.
 * 
...
class PlatformManagerStub extends Stub implements PlatformManager {
  ...
  public String addNode(NodeDescriptor desc, Vector services, boolean propagated)
  ...
  public void removeNode(NodeDescriptor desc, boolean propagate)
