...
/**
 * Serializer interface. This interface must be implemented to allow custom classes to be
 * automatically serialized by LEAP IMTP.
 * 
...
interface Serializer {
  ...
  /**
   * This method serializes an object according to the LEAP serialization mechanism.
   * 
  ...
  /**
   * This method deserializes an object according to the LEAP serialization mechanism.
   * 
