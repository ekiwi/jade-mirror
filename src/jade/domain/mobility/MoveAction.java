...
/**
 * 
 * This class represents the <code>move-agent</code> action, requesting to move an agent within the
 * platform.
 * 
...
public class MoveAction implements AgentAction {
  ...
  /**
   * Retrieve the value of the <code>mobile-agent-description</code> slot of this event, containing
   * the description of the agent to migrate.
   * 
   * @return The value of the <code>mobile-agent-description</code> slot, or <code>null</code> if no
   *         value was set.
   */
