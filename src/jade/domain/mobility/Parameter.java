...
/**
 * This concept represents a parameter to be passed to a <code>Behaviour</code> in the dynamic
 * loading procedure.
 * 
 * @see LoadBehaviour
...
public class Parameter implements Concept {
  ...
  /**
   * Sets the name of this parameter. This will be used as the key in the dinamically loaded
   * behaviour <code>DataStore</code> for the parameter value
   */
  ...
  /**
   * Sets the value of this parameter. The BehaviourLoading ontology extends the
   * SerializableOntology and therefore whatever <code>Serializable</code> object can be used.
   */
  ...
  /**
   * Sets the IO mode of this parameter. This must be one of <code>IN_MODE</code>,
   * <code>OUT_MODE</code>, <code>INOUT_MODE</code>.
   */
