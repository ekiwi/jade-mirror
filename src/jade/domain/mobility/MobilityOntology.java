...
/**
 * This class represents the ontology used for JADE mobility. There is only a single instance of
 * this class.
 * 
...
public class MobilityOntology extends Ontology implements MobilityVocabulary {
  ...
  private MobilityOntology() {
    ...
    try {
      ...
      cs.add(MOBILE_AGENT_DESCRIPTION_AGENT_PROFILE,
          (ConceptSchema) getSchema(MOBILE_AGENT_PROFILE), ObjectSchema.OPTIONAL);
      cs.add(MOBILE_AGENT_DESCRIPTION_AGENT_VERSION,
          (PrimitiveSchema) getSchema(BasicOntology.STRING), ObjectSchema.OPTIONAL);
      cs.add(MOBILE_AGENT_DESCRIPTION_SIGNATURE, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);

      cs = (ConceptSchema) getSchema(MOBILE_AGENT_PROFILE);
      cs.add(MOBILE_AGENT_PROFILE_SYSTEM, (ConceptSchema) getSchema(MOBILE_AGENT_SYSTEM),
          ObjectSchema.OPTIONAL);
      cs.add(MOBILE_AGENT_PROFILE_LANGUAGE, (ConceptSchema) getSchema(MOBILE_AGENT_LANGUAGE),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(MOBILE_AGENT_SYSTEM_MINOR_VERSION, (PrimitiveSchema) getSchema(BasicOntology.INTEGER),
          ObjectSchema.OPTIONAL);
      cs.add(MOBILE_AGENT_SYSTEM_DEPENDENCIES, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(MOBILE_AGENT_LANGUAGE_MAJOR_VERSION,
          (PrimitiveSchema) getSchema(BasicOntology.INTEGER));
      cs.add(MOBILE_AGENT_LANGUAGE_MINOR_VERSION,
          (PrimitiveSchema) getSchema(BasicOntology.INTEGER), ObjectSchema.OPTIONAL);
      cs.add(MOBILE_AGENT_LANGUAGE_DEPENDENCIES, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(MOBILE_AGENT_OS_MINOR_VERSION, (PrimitiveSchema) getSchema(BasicOntology.INTEGER),
          ObjectSchema.OPTIONAL);
      cs.add(MOBILE_AGENT_OS_DEPENDENCIES, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      ...
      // as.add(CLONE_MOBILE_AGENT_DESCRIPTION,
