...
/**
 * This class represents the BehaviourLoading ontology including the concepts and actions required
 * to dynamically load and execute jade behaviours whose code is not included in the JVM classpath.
 * 
...
public class BehaviourLoadingOntology extends Ontology implements BehaviourLoadingVocabulary {
   ...
   *         the Behaviour-Loading ontology.
   */
  ...
  private BehaviourLoadingOntology() {
    ...
    try {
      ...
      as.add(LOAD_BEHAVIOUR_CODE, (PrimitiveSchema) getSchema(BasicOntology.BYTE_SEQUENCE),
          ObjectSchema.OPTIONAL);
      as.add(LOAD_BEHAVIOUR_ZIP, (PrimitiveSchema) getSchema(BasicOntology.BYTE_SEQUENCE),
          ObjectSchema.OPTIONAL);
      as.add(LOAD_BEHAVIOUR_PARAMETERS, (ConceptSchema) getSchema(PARAMETER), 0,
