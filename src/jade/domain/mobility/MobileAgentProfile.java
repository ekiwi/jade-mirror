...
public class MobileAgentProfile implements Concept {
  ...
  /**
   * Retrieve the value of the <code>system</code> slot of this action, containing the runtime
   * system of the described agent.
   * 
   * @return The value of the <code>system</code> slot, or <code>null</code> if no value was set.
   */
  ...
  /**
   * Retrieve the value of the <code>language</code> slot of this action, containing the language of
   * the described agent.
   * 
   * @return The value of the <code>language</code> slot, or <code>null</code> if no value was set.
   */
  ...
  /**
   * Retrieve the value of the <code>os</code> slot of this action, containing the OS of the
   * described agent.
   * 
   * @return The value of the <code>os</code> slot, or <code>null</code> if no value was set.
   */
