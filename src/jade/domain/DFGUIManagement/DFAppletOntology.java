...
/**
 * This class represents the ontology <code>DFApplet-management</code>, containing all JADE
 * extensions related to applet management. There is only a single instance of this class.
 * <p>
...
public class DFAppletOntology extends Ontology implements DFAppletVocabulary {
  ...
  private DFAppletOntology() {
    ...
    try {
      ...
      as.add(FEDERATE_DESCRIPTION, (TermSchema) getSchema(DFAGENTDESCRIPTION),
