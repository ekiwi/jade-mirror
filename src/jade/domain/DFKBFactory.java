 ...
 * compliance with the FIPA specifications. Copyright (C) 2004 CSELT S.p.A.
 *
...
/**
 * The <code>DFKBFactory</code> class creates knowledge base objects used by the DF.
 * 
 * <p>
 * To run JADE with your own knowledge base implementation a new sub class of
 * <code>DFKBFactory</code>, overriding the appropriate method(s), has to be implemented and
 * specified by the command line parameter <code>-jade_domain_df_kb-factory</code>.
 * </p>
 * 
...
public class DFKBFactory {
   ...
   */
  protected DBKB getDFDBKB(int maxResultLimit, String driver, String url, String user,
      String passwd, boolean cleanTables) throws SQLException {
    ...
    /*
     * #ANDROID_INCLUDE_BEGIN throw new SQLException("Unsupported SQL KB"); #ANDROID_INCLUDE_END
     */
  }
}
