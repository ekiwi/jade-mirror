...
/**
 * This class provides a single access point for the set of constants already defined by FIPA. The
 * constants have been grouped by category (i.e. ACLCodecs, Content Languages, MTPs, ...), with one
 * inner class implementing each category.
 * 
...
public interface FIPANames {
  ...
  public static interface InteractionProtocol {
    ...
    /**
     * The Iterated-Fipa-Request interaction protocol. Note that this protocol is defined in JADE
     * and is not a standard FIPA protocol.
     */
