...
/**
 * This behaviour serves the actions of the FIPA management ontology supported by the AMS. Extends
 ...
 * whether a result should be returned (RESULT or DONE). Note that all actions in the
 * FIPAManagementOntology produce a "synchronous" effect --> there is no need to delay the
 * notification at a later time as for some actions in the JADEManagementOntology.
 * 
