...
/**
 * This interface must be implemented by a GUI that wants to interact with the DF agent. Two
 * implementations of this interface have been realized: the class jade.domain.df (used by the DF
 * agent itself) and the class jade.applet.DFAppletCommunicator (used by the DFApplet).
 * 
...
public interface DFGUIAdapter {
  ...
  /**
   * This method returns the agent description of an agent registered with the DF given the agent
   * name
   */
