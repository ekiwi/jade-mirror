...
/**
 * This class implements the concept of the fipa-agent-management ontology representing the
...
public class DFAgentDescription implements Concept {
   ...
   * 
   * @param absoluteTime The lease time for the registration of this DFAgentDescription as an
   *        absolute time. Use <code>null</code> (default) to indicate an infinite lease time
   */
  ...
  /**
   * Retrieve the lease time for the registration of this description (i.e., how long it will be
   * kept within the DF agent knowledge base).
   * 
   * @return The lease time for the registration of this <code>DFAgentDescription</code> as an
   *         absolute time. A <code>null</code> value indicates an infinite time.
   */
  ...
  /**
   * Set the lease time for the registration of this <code>DFAgentDescription</code> as a relative
   * time.
   * 
   * @param relativeTime The lease time for the registration of this DFAgentDescription as a
   *        relative time.
   */
  ...
  /**
   * Indicates whether the lease time for the registration of this <code>DFAgentDescription</code>
   * expired.
   * 
   * @return If the lease time expired, <code>true</code> is returned, and <code>false</code>
   *         otherwise.
   */
  ...
  /**
   * Remove all service descriptions from the <code>services</code> slot collection of this object.
   */
  ...
  /**
   * Access all service descriptions from the <code>services</code> slot collection of this object.
   * 
  ...
  /**
   * Remove all protocol names from the <code>protocols</code> slot collection of this object.
   */
  ...
  /**
   * Access all protocol names from the <code>protocols</code> slot collection of this object.
   * 
  ...
  /**
   * Remove all ontology names from the <code>ontologies</code> slot collection of this object.
   */
  ...
  /**
   * Access all ontology names from the <code>ontologies</code> slot collection of this object.
   * 
  ...
  /**
   * Remove all content language names from the <code>languages</code> slot collection of this
   * object.
   */
  ...
  /**
   * Access all content language names from the <code>languages</code> slot collection of this
   * object.
   * 
