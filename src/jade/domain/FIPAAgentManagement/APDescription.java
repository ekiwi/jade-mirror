 ...
 * description of an agent platform as it can be retrieved from the AMS.
 * 
...
public class APDescription implements Concept {
   ...
   * 
   * @return The value of the <code>name</code> slot of this platform description, or
  ...
  /**
   * Add a service to the <code>ap-services</code> slot collection of this object.
   * 
  ...
  /**
   * Remove a service from the <code>ap-services</code> slot collection of this object.
   * 
  ...
  /**
   * Remove all services from the <code>ap-services</code> slot collection of this object.
   */
  ...
  /**
   * Access all services from the <code>ap-services</code> slot collection of this object.
   * 
