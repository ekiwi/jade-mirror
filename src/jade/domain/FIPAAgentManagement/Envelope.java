...
public class Envelope implements Concept, jade.util.leap.Serializable {
  ...
  /**
   * Add an agent identifier to the <code>to</code> slot collection of this object.
   * 
  ...
  /**
   * Remove an agent identifier from the <code>to</code> slot collection of this object.
   * 
  ...
  /**
   * Remove all agent identifiers from the <code>to</code> slot collection of this object.
   */
  ...
  /**
   * Access all agent identifiers from the <code>to</code> slot collection of this object.
   * 
   ...
   * 
   * @return The value of the <code>from</code> slot of this envelope, or <code>null</code> if no
   *         value was set.
   */
  public AID getFrom() {
    return from;
   ...
   * 
   * @return The value of the <code>comments</code> slot of this envelope, or <code>null</code> if
   *         no value was set.
   */
   ...
   * 
   * @return The value of the <code>acl-representation</code> slot of this envelope, or
   ...
   * 
   * @return The value of the <code>payload-length</code> slot of this envelope, or
   *         <code>null</code> or a negative value if no value was set.
   */
  ...
  /**
   * Set the <code>payload-encoding</code> slot of this object. This slot can be used to specify a
   * different charset than the standard one (US-ASCII) in order for instance to support accentuated
   * characters in the content slot of the ACL message (e.g. setPayloadEncoding("UTF-8")).
   * 
   ...
   * 
   * @return The value of the <code>payload-encoding</code> slot of this envelope, or
   *         <code>null</code> if no value was set.
   */
   ...
   * 
   * @return The value of the <code>date</code> slot of this envelope, or <code>null</code> if no
   *         value was set.
   */
  public Date getDate() {
    return date;
  ...
  /**
   * Add an agent identifier to the <code>intended-receiver</code> slot collection of this object.
   * 
   * @param id The agent identifier to add to the collection.
   */
  ...
  /**
   * Remove an agent identifier from the <code>intended-receiver</code> slot collection of this
   * object.
   * 
  ...
  /**
   * Remove all agent identifiers from the <code>intended-receiver</code> slot collection of this
   * object.
   */
   ...
   * 
   * @return The value of the <code>received</code> slot of this envelope, or <code>null</code> if
   *         no value was set.
   */
  ...
  /**
   * Add a <code>received-object</code> stamp to this message envelope. This method is used by the
   * ACC to add a new stamp to the envelope at every routing hop.
   * 
  ...
  /**
   * Access the list of all the stamps. The <code>received-object</code> stamps are sorted according
   * to the routing path, from the oldest to the newest.
   */
  ...
  /**
   * Remove a property from the <code>properties</code> slot collection of this object.
   * 
  ...
  /**
   * Remove all properties from the <code>properties</code> slot collection of this object.
   */
  ...
  /**
   * Access all properties from the <code>properties</code> slot collection of this object.
   * 
