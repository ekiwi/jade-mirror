 ...
 * <code>fipa-agent-management ontology</code>. This action is supported by (and can be requested
 * to) both the AMS and the DF.
 * 
...
public class Search implements AgentAction {
   ...
   * 
   * @return The value of the <code>description</code> slot of this action, or <code>null</code> if
   *         no value was set.
   */
   ...
   * 
   * @return The value of the <code>constraints</code> slot of this action, or <code>null</code> if
   *         no value was set.
   */
