 ...
 * 23).
 * <p>
 * The actual <code>Ontology</code> object representing the FIPA-Agent-Management-ontology is a
 * singleton and is accessible through the static method <code>getInstance()</code>
 * 
...
public class FIPAManagementOntology extends Ontology implements FIPAManagementVocabulary {
  ...
  /**
   * This method returns the unique instance (according to the singleton pattern) of the
   * FIPA-Agent-Management-ontology.
   * 
   * @return The singleton <code>Ontology</code> object, containing the schemas for the elements of
  ...
  private FIPAManagementOntology() {
    // #MIDP_EXCLUDE_BEGIN
    super(NAME,
        new Ontology[] {ExceptionOntology.getInstance(), SerializableOntology.getInstance()},
        new BCReflectiveIntrospector());
    // #MIDP_EXCLUDE_END

    /*
     * #MIDP_INCLUDE_BEGIN super(NAME, ExceptionOntology.getInstance(), null); #MIDP_INCLUDE_END
     */
    ...
    try {
      ...
      /*
       * #MIDP_INCLUDE_BEGIN add(new ConceptSchema(DFAGENTDESCRIPTION)); add(new
       * ConceptSchema(SERVICEDESCRIPTION)); add(new ConceptSchema(SEARCHCONSTRAINTS)); add(new
       * ConceptSchema(AMSAGENTDESCRIPTION)); add(new ConceptSchema(PROPERTY)); add(new
       * ConceptSchema(ENVELOPE)); add(new ConceptSchema(RECEIVEDOBJECT)); add(new
       * ConceptSchema(APDESCRIPTION)); add(new ConceptSchema(APSERVICE));
       * 
       * add(new AgentActionSchema(REGISTER)); add(new AgentActionSchema(DEREGISTER)); add(new
       * AgentActionSchema(MODIFY)); add(new AgentActionSchema(SEARCH)); add(new
       * AgentActionSchema(GETDESCRIPTION));
       * 
       * add(new PredicateSchema(ALREADYREGISTERED)); add(new PredicateSchema(NOTREGISTERED));
       * #MIDP_INCLUDE_END
       */

      ConceptSchema cs = (ConceptSchema) getSchema(DFAGENTDESCRIPTION);
      cs.add(DFAGENTDESCRIPTION_NAME, (ConceptSchema) getSchema(BasicOntology.AID),
          ObjectSchema.OPTIONAL);
      cs.add(DFAGENTDESCRIPTION_SERVICES, (ConceptSchema) getSchema(SERVICEDESCRIPTION), 0,
          ObjectSchema.UNLIMITED, BasicOntology.SET);
      cs.add(DFAGENTDESCRIPTION_PROTOCOLS, (PrimitiveSchema) getSchema(BasicOntology.STRING), 0,
          ObjectSchema.UNLIMITED, BasicOntology.SET);
      cs.add(DFAGENTDESCRIPTION_LANGUAGES, (PrimitiveSchema) getSchema(BasicOntology.STRING), 0,
          ObjectSchema.UNLIMITED, BasicOntology.SET);
      cs.add(DFAGENTDESCRIPTION_ONTOLOGIES, (PrimitiveSchema) getSchema(BasicOntology.STRING), 0,
          ObjectSchema.UNLIMITED, BasicOntology.SET);
      cs.add(DFAGENTDESCRIPTION_LEASE_TIME, (PrimitiveSchema) getSchema(BasicOntology.DATE),
          ObjectSchema.OPTIONAL);

      cs = (ConceptSchema) getSchema(SERVICEDESCRIPTION);
      cs.add(SERVICEDESCRIPTION_NAME, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      cs.add(SERVICEDESCRIPTION_TYPE, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      cs.add(SERVICEDESCRIPTION_OWNERSHIP, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      cs.add(SERVICEDESCRIPTION_PROTOCOLS, (PrimitiveSchema) getSchema(BasicOntology.STRING), 0,
          ObjectSchema.UNLIMITED, BasicOntology.SET);
      cs.add(SERVICEDESCRIPTION_LANGUAGES, (PrimitiveSchema) getSchema(BasicOntology.STRING), 0,
          ObjectSchema.UNLIMITED, BasicOntology.SET);
      cs.add(SERVICEDESCRIPTION_ONTOLOGIES, (PrimitiveSchema) getSchema(BasicOntology.STRING), 0,
          ObjectSchema.UNLIMITED, BasicOntology.SET);
      cs.add(SERVICEDESCRIPTION_PROPERTIES, (ConceptSchema) getSchema(PROPERTY), 0,
          ObjectSchema.UNLIMITED, BasicOntology.SET);

      cs = (ConceptSchema) getSchema(SEARCHCONSTRAINTS);
      cs.add(SEARCHCONSTRAINTS_MAX_DEPTH, (PrimitiveSchema) getSchema(BasicOntology.INTEGER),
          ObjectSchema.OPTIONAL);
      cs.add(SEARCHCONSTRAINTS_MAX_RESULTS, (PrimitiveSchema) getSchema(BasicOntology.INTEGER),
          ObjectSchema.OPTIONAL);
      cs.add(SEARCHCONSTRAINTS_SEARCH_ID, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);

      cs = (ConceptSchema) getSchema(AMSAGENTDESCRIPTION);
      cs.add(AMSAGENTDESCRIPTION_NAME, (ConceptSchema) getSchema(BasicOntology.AID),
          ObjectSchema.OPTIONAL);
      cs.add(AMSAGENTDESCRIPTION_OWNERSHIP, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      cs.add(AMSAGENTDESCRIPTION_STATE, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);

      cs = (ConceptSchema) getSchema(PROPERTY);
      cs.add(PROPERTY_NAME, (PrimitiveSchema) getSchema(BasicOntology.STRING));
      cs.add(PROPERTY_VALUE, (TermSchema) TermSchema.getBaseSchema(), ObjectSchema.OPTIONAL); // In
                                                                                              // a
                                                                                              // template
                                                                                              // we
                                                                                              // can
      ...
      cs.add(ENVELOPE_COMMENTS, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(ENVELOPE_INTENDEDRECEIVER, (ConceptSchema) getSchema(BasicOntology.AID), 0,
          ObjectSchema.UNLIMITED);
      cs.add(ENVELOPE_RECEIVED, (ConceptSchema) getSchema(RECEIVEDOBJECT), ObjectSchema.OPTIONAL);
      cs.add(ENVELOPE_PROPERTIES, (ConceptSchema) getSchema(PROPERTY), 0, ObjectSchema.UNLIMITED,
          BasicOntology.SET);
      ...
      cs.add(APDESCRIPTION_SERVICES, (ConceptSchema) getSchema(APSERVICE), 0,
          ObjectSchema.UNLIMITED);
      ...
      cs.add(APSERVICE_ADDRESSES, (PrimitiveSchema) getSchema(BasicOntology.STRING), 0,
          ObjectSchema.UNLIMITED);
      ...
      as.add(DEREGISTER_DESCRIPTION, (TermSchema) TermSchema.getBaseSchema(),
      ...
      as.add(SEARCH_CONSTRAINTS, (ConceptSchema) getSchema(SEARCHCONSTRAINTS),
          ObjectSchema.MANDATORY);
      as.setEncodingByOrder(true);
