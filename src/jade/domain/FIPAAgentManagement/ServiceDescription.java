...
public class ServiceDescription implements Concept {
   ...
   * 
   * @return The value of the <code>name</code> slot of this service description, or
   ...
   * 
   * @return The value of the <code>type</code> slot of this service description, or
   *         <code>null</code> if no value was set.
   */
   ...
   * 
   * @return The value of the <code>ownership</code> slot of this service description, or
   *         <code>null</code> if no value was set.
   */
