...
/**
 * This class implements the <code>property</code> type, a pair of a name and value.
 * 
...
public class Property implements Concept {
   ...
   * 
   * @return The string that is the name of this property, or <code>null</code> if no name was set.
   */
