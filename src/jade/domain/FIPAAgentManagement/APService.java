...
public class APService implements Concept {
  ...
  /**
   * Constructor. Create a new APService where name and type get the same value (i.e. the passed
   * type parameter).
   **/
   ...
   * 
   * @return The value of the <code>name</code> slot of this platform service description, or
   ...
   * 
   * @return The value of the <code>type</code> slot of this platform service description, or
   *         <code>null</code> if no value was set.
   */
  ...
  /**
   * Add a service to the <code>addresses</code> slot collection of this object.
   * 
  ...
  /**
   * Remove a service from the <code>addresses</code> slot collection of this object.
   * 
  ...
  /**
   * Remove all addresses from the <code>addresses</code> slot collection of this object.
   */
  ...
  /**
   * Access all addresses from the <code>addresses</code> slot collection of this object.
   * 
