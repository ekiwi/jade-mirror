...
/**
 * This class represents a generic FIPAException, i.e. one of NotUnderstood,Failure,Refuse, as
 * defined in <code>jade.domain.FIPAAgentManagement</code>. It has two constructors, one based on an
 * ACLMessage, and the second based on its content, i.e. the exception message.
 * 
...
public class FIPAException extends Exception implements Predicate {
  ...
  /**
   * Constructs a generic <code>FIPAException</code>. The ACL message performative is defaulted to
   ...
   * 
   * @return A string representing the message content that describes this FIPA exception.
   **/
