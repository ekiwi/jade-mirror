...
/**
 * 
 * This class represents the <code>debug-on</code> action, requesting a debugger to start observing
 * a set of agents in the platform.
 * 
...
public class DebugOn implements AgentAction {
  ...
  /**
   * Retrieve the value of the <code>debugger</code> slot of this action, containing the agent
   * identifier of the debugger agent.
   * 
   * @return The value of the <code>debugger</code> slot, or <code>null</code> if no value was set.
   */
  ...
  /**
   * Remove all agent identifiers from the <code>debugged-agents</code> slot collection of this
   * object.
   */
  ...
  /**
   * Add an agent identifier to the <code>debugged-agents</code> slot collection of this object.
   * 
  ...
  /**
   * Remove an agent identifier from the <code>debugged-agents</code> slot collection of this
   * object.
   * 
  ...
  /**
   * Access all agent identifiers from the <code>debugged-agents</code> slot collection of this
   * object.
   * 
   ...
   * <code>getAllDebuggedAgents()</code> cannot be used as it returns an <code>Iterator</code> that
   * is not serializable.
   */
   ...
   * 
   * @param p The password used to authenticate the principal requesting this action.
   */
  ...
  /**
   * Retrieve the value of the <code>password</code> slot of this action, containing the password
   * used to authenticate the principal requesting this action.
   * 
   * @return The value of the <code>password</code> slot, or <code>null</code> if no value was set.
   */
