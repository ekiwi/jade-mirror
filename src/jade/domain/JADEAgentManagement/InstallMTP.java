 ...
 * install a new MTP for inter-platform communication on a given container.
 * 
 * 
...
public class InstallMTP implements AgentAction {
   ...
   * 
   * @param cid The container identifier of the container where the new MTP is to be deployed.
   */
   ...
   * identifier of the container where the new MTP is to be deployed.
   * 
   ...
   * 
   * @param a The name of the Java class implementing the MTP endpoint to install.
   */
  ...
  /**
   * Retrieve the value of the <code>class-name</code> slot of this action, containing the name of
   * the Java class implementing the MTP endpoint to install.
   * 
