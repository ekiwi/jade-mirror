 ...
 * retrieve the list of agents running on a given container.
 * 
...
public class QueryAgentsOnLocation implements AgentAction {
  ...
  /**
   * Retrieve the value of the <code>location</code> slot of this event, containing the location for
   * which the agent list is requested.
   * 
   * @return The value of the <code>location</code> slot, or <code>null</code> if no value was set.
   */
