...
/**
 * This interface contains all the string constants for frame and slot names of exceptions defined
 * in the <code>jade-agent-management</code> ontology.
 */
public interface JADEManagementVocabulary extends ExceptionVocabulary {
  ...
  public static final String NOTREGISTERED =
      jade.domain.FIPAAgentManagement.FIPAManagementVocabulary.NOTREGISTERED;
  public static final String ALREADYREGISTERED =
      jade.domain.FIPAAgentManagement.FIPAManagementVocabulary.ALREADYREGISTERED;
