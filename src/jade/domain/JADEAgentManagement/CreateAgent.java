 ...
 * create a new agent on a given container.
 * 
...
public class CreateAgent implements AgentAction {
   ...
   * 
   * @param an The local name (i.e. without the platform ID) of the agent to create.
   */
  ...
  /**
   * Retrieve the value of the <code>agent-name</code> slot of this event, containing the local name
   * (i.e. without the platform ID) of the agent to create.
   * 
   * @return The value of the <code>agent-name</code> slot, or <code>null</code> if no value was
   *         set.
   */
  ...
  /**
   * Retrieve the value of the <code>class-name</code> slot of this event, containing the name of
   * the Java class implementing the agentto create.
   * 
   * @return The value of the <code>class-name</code> slot, or <code>null</code> if no value was
   *         set.
   */
   ...
   * 
   * @param cid The container identifier of the container where the agent is to be created.
   */
  ...
  /**
   * Retrieve the value of the <code>container</code> slot of this event, containing the container
   * identifier of the container where the agent is to be created.
   * 
  ...
  /**
   * Remove all objects from the <code>arguments</code> slot collection of this object.
   */
