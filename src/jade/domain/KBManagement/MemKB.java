...
public abstract class MemKB extends KB {
  ...
  /**
   * Iterated search is only supported in a DB-based KB. Throw a RuntimeException. The requester
   * will get back a FAILURE
   */
  ...
  //
  public void subscribe(Object dfd, SubscriptionResponder.Subscription s)
  ...
  private SubscriptionResponder.Subscription getSubscription(Object key) {
    SubscriptionResponder.Subscription sub =
        (SubscriptionResponder.Subscription) subscriptions.get(key);
    return sub;
  }
