...
/**
 * <code>DFHSQLKB</code> realizes a knowledge base used by the DF which stores its content in an
 * HSQL database, running in the same VM. The SQL commands are optimized for the HSQL database.
 * 
...
public class DFHSQLKB extends DFDBKB {
  ...
  protected Connection createDBConnection(String url, String user, String passwd)
      throws SQLException {
