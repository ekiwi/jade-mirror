...
public class AddedContainer implements Event {
   ...
   * identifier of the newly added container.
   * 
  ...
  /**
   * Retrieve the value of the <code>ownership</code> slot of this event, containing the name of the
   * entity owning the newly added container.
   * 
