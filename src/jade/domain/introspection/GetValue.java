...
/**
 * This class represents the <code>get-value</code> action of the Introspection Ontology. This
 * action allows querying an agent that is running an IntrospectionServer behaviour for the value
