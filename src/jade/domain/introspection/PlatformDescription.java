...
/**
 * This class represents the <code>platform-description</code> predicate, whose argument is a
 * platform description object from the FIPA Agent Management ontology.
 * 
...
public class PlatformDescription implements Event {
  ...
  /**
   * Retrieve the value of the <code>platform</code> slot of this event, containing the
   * <code>ap-description</code> this notification refers to.
   * 
   * @return The value of the <code>platform</code> slot, or <code>null</code> if no value was set.
   */
