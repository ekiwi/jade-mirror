...
public class DeadAgent implements Event {
   ...
   * 
   * @param id The container identifier of the container where the newly dead agent was deployed.
   */
   ...
   * identifier of the container where the newly dead agent was deployed.
   * 
   ...
   * identifier of the newly dead agent.
   * 
