...
/**
 * This class represents the ontology <code>jade-introspection</code>, containing all JADE
 * extensions related to agent and platform monitoring. There is only a single instance of this
 * class.
 * 
 * <p>
...
public class IntrospectionOntology extends Ontology implements IntrospectionVocabulary {
  ...
  private IntrospectionOntology() {
    ...
    try {
      ...
      cs.add(EVENTRECORD_WHEN, (PrimitiveSchema) getSchema(BasicOntology.DATE),
      ...
      cs.add(BEHAVIOURID_KIND, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      cs.add(BEHAVIOURID_CHILDREN, (ConceptSchema) getSchema(BEHAVIOURID), 0,
          ObjectSchema.UNLIMITED);
      cs.add(BEHAVIOURID_CODE, (PrimitiveSchema) getSchema(BasicOntology.INTEGER),
          ObjectSchema.OPTIONAL);

      cs = (ConceptSchema) getSchema(ACLMESSAGE);
      cs.add(ACLMESSAGE_ENVELOPE, (ConceptSchema) getSchema(ENVELOPE), ObjectSchema.OPTIONAL);
      cs.add(ACLMESSAGE_ACLREPRESENTATION, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      cs.add(ACLMESSAGE_PAYLOAD, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(CHANNEL_NAME, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      cs.add(CHANNEL_PROTOCOL, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(ADDEDCONTAINER_OWNERSHIP, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(BORNAGENT_STATE, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      cs.add(BORNAGENT_OWNERSHIP, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      cs.add(BORNAGENT_CLASS_NAME, (PrimitiveSchema) getSchema(BasicOntology.STRING),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(DEADAGENT_CONTAINER_REMOVED, (PrimitiveSchema) getSchema(BasicOntology.BOOLEAN),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(FROZENAGENT_BUFFERCONTAINER, (ConceptSchema) getSchema(CONTAINERID),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(THAWEDAGENT_BUFFERCONTAINER, (ConceptSchema) getSchema(CONTAINERID),
          ObjectSchema.OPTIONAL);
      ...
      cs.add(CHANGEDAGENTOWNERSHIP_WHERE, (ConceptSchema) getSchema(CONTAINERID),
          ObjectSchema.OPTIONAL);
      ...
      as.add(STARTNOTIFY_EVENTS, (PrimitiveSchema) getSchema(BasicOntology.STRING), 0,
          ObjectSchema.UNLIMITED);

      as = (AgentActionSchema) getSchema(STOPNOTIFY);
      as.add(STOPNOTIFY_OBSERVED, (ConceptSchema) getSchema(BasicOntology.AID));
      as.add(STOPNOTIFY_EVENTS, (PrimitiveSchema) getSchema(BasicOntology.STRING), 0,
          ObjectSchema.UNLIMITED);
