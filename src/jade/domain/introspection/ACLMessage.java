...
public class ACLMessage implements Concept {
   ...
   * 
   * @return The transport-level envelope attached to this ACL message, or <code>null</code> if no
   *         envelope was set.
   */
   ...
   * 
   * @param p A string containing the encoding of the payload according to a concrete ACL
   *        representaiton.
   */
   ...
   * 
   * @return A string containing the encoding of the payload according to a concrete ACL
   *         representation.
   */
