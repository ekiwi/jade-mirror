...
public class EventRecord implements Concept {
  ...
  /**
   * Retrieve the value of the <code>what</code> slot of this event, containing the occurred event.
   * 
   * @return The value of the <code>what</code> slot, or <code>null</code> if no value was set.
   */
  ...
  /**
   * Retrieve the value of the <code>when</code> slot of this event, containing the time instant
   * when the event occurred.
   * 
   * @return The value of the <code>when</code> slot, or <code>null</code> if no value was set.
   */
  public Date getWhen() {
    return when;
  }
  ...
  /**
   * Retrieve the value of the <code>where</code> slot of this event, containing the location where
   * the event occurred.
   * 
