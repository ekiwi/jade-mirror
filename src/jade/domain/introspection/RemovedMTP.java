...
public class RemovedMTP implements Event {
   ...
   * 
   * @param id The container identifier of the container where the newly removed MTP was deployed.
   */
   ...
   * identifier of the container where the newly removed MTP was deployed.
   * 
