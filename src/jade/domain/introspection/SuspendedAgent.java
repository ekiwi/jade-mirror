...
public class SuspendedAgent implements Event {
   ...
   * 
   * @param id The container identifier of the container where the newly suspended agent was
   *        deployed.
   */
   ...
   * identifier of the container where the newly suspended agent was deployed.
   * 
