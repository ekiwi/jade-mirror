...
public class SentMessage implements Event {
   ...
   * 
   * @param id The agent identifier of the unicast receiver of the sent message.
   */
  ...
  /**
   * Retrieve the value of the unicast <code>receiver</code> slot of this event.
   * 
   * @return The value of the unicast <code>receiver</code> slot, or <code>null</code> if no value
   *         was set.
   */
