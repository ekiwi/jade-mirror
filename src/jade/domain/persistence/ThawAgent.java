...
/**
 * This class represents the <code>thaw-agent</code> action of the <code>JADE-Persistence</code>
 * ontology. This action can be requested to the JADE AMS to thaw a frozen agent, whose state is
 * moved to a persistent storage, and deliver to it its messages, previously buffered by the
 * platform.
 * 
