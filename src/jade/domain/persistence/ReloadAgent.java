...
/**
 * This class represents the <code>reload-agent</code> action of the <code>JADE-Persistence</code>
 * ontology. This action can be requested to the JADE AMS to save an agent on a persistent storage.
 * 
