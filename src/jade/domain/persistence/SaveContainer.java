...
/**
 * This class represents the <code>save-container</code> action of the <code>JADE-Persistence</code>
 * ontology. This action can be requested to the JADE AMS to save an agent container on a persistent
 * storage.
 * 
