...
/**
 * This class represents the <code>delete-agent</code> action of the <code>JADE-Persistence</code>
 * ontology. This action can be requested to the JADE AMS to create a new agent on a given
 * container.
 * 
