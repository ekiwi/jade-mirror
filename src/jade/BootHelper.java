...
/**
 * This class provides a number of methods that help in parsing the command line. It is also used by
 * the StartNewAgent class of the RMA.
 * 
...
public class BootHelper {
  ...
  /**
   * Reads the passed String and decompose it into a vector of Strings. Each String is a token of
   * type agentName: or className( or argument This method is declared public because it is
   * currently used by <code>jade.tools.rma.StartNewAgentAction</code>
   *
   * @param s1 The source string.
   * @param keepquote when true no char is removed, apart from blanks between tokens. when false,
   *        quote chars are removed and also escaped quotes become just quotes.
   *
  ...
  /**
   * parse an array of Strings and return an Iterator of <code>Specifier</code> This method is
   * declared public because it is currently used by <code>jade.tools.rma.StartNewAgentAction</code>
   * 
   * @param args is an array of string of agent specifiers of the type "name:class(arguments)"
