...
public class Boot {
  ...
  /**
   * Fires up the <b><em>JADE</em></b> system. This method initializes the Profile Manager and then
   * starts the bootstrap process for the <B><em>JADE</em></b> agent platform.
   */
  public static void main(String args[]) {
    try {
      ...
      // #PJAVA_EXCLUDE_END
      /*
       * #PJAVA_INCLUDE_BEGIN // Starts the container in SINGLE_MODE (Only one per JVM)
       * Runtime.instance().startUp(p); #PJAVA_INCLUDE_END
       */
