...
public class myFipaContractNetInitiatorBehaviour extends ContractNetInitiator {
  ...
  protected void handleAllResponses(Vector proposals, Vector retMsgs) {
    // System.err.println(myAgent.getLocalName()+": FipacontractNetInitiator is
    ...
    for (int i = 0; i < proposals.size(); i++) {
      // System.err.println("EvaluateProposals, start round "+i+" acceptableDates =
      // "+acceptableDates.toString());
      ...
      // System.err.println("EvaluateProposals, end rounds acceptableDates =
      // "+acceptableDates.toString());
